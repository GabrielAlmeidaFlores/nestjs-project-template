...
- Todos os campos textuais devem ser escritos em texto corrido normal
- Não use Markdown em nenhum campo textual desta resposta
- Não use títulos com #, negrito com **, itálico com _, listas, tabelas, pipes, blocos de código ou qualquer marcação visual

---

## ESTRUTURA OBRIGATÓRIA DA RESPOSTA

Sua resposta deve seguir rigorosamente a estrutura abaixo e conter apenas o objeto estruturado, sem explicações antes ou depois:

\`\`\`
{
  "insuredQualityAnalysis": {
    "isConfirmed": true,
    "status": "QUALIDADE_DE_SEGURADO_MANTIDA",
    "description": "Texto corrido normal, sem markdown, explicando a conclusão da qualidade de segurada."
  },
  "carenciaAnalysis": {
    "isConfirmed": true,
    "status": "Isento_de_Carencia_Base_Artigo_25_Lei_8213",
    "description": "Texto corrido normal, sem markdown, explicando a conclusão sobre a carência."
  },
  "requirementAnalysis": {
    "status": "Dentro_do_prazo_de_requiremento",
    "eventDate": "2026-03-29T00:00:00.000Z",
    "requirementDate": "2026-03-29T00:00:00.000Z",
    "statutoryPeriod": "Até 5 anos após a data do fato gerador",
    "details": "Texto corrido normal, sem markdown, explicando o prazo do requerimento.",
    "rationale": "Texto corrido normal, sem markdown, com a fundamentação jurídica do prazo."
  },
  "applicationDeadlineAnalysis": {
    "status": "PARTO_NORMAL",
    "duration": "120 dias",
    "startDate": "2026-03-29T00:00:00.000Z",
    "terminationDate": "2026-07-27T00:00:00.000Z",
    "startLeaveDate": "2026-03-29T00:00:00.000Z",
    "endLeaveDate": "2026-07-27T00:00:00.000Z",
    "total": 120,
    "amountBenefit": "Texto corrido curto, sem markdown, com o valor estimado ou a justificativa de indisponibilidade do cálculo.",
    "calculationBasis": "Texto corrido normal, sem markdown, explicando a base de cálculo."
  },
  "benefitEligibilityAnalysis": {
    "isConfirmed": true,
    "description": "Texto corrido normal, sem markdown, indicando se há elegibilidade e quais pendências condicionam o direito."
  },
  "periods": [
    {
      "name": "Nome do vínculo ou período",
      "startDate": "2020-01-01T00:00:00.000Z",
      "endDate": "2020-12-31T00:00:00.000Z",
      "category": "EMPREGADO_URBANO",
      "gracePeriod": 12,
      "status": true,
      "isPendency": false,
      "competenceBelowTheMinimum": false,
      "contributionAverage": 1800.5,
      "belowMinimumContributions": [],
      "reasonPendency": "LEAVE_DATE",
      "bondOrigin": "Empresa XYZ",
      "complementViaMyInss": false,
      "impact": "Texto corrido curto, sem markdown, explicando o impacto do período.",
      "typeOfContribution": "Texto corrido curto, sem markdown, quando aplicável.",
      "periodConsideration": "SIM"
    }
  ],
  "lastContribution": "2026-03-01T00:00:00.000Z",
  "categoryAtDfg": "Empregado Rural",
  "employmentBondStatus": "Ativo"
}
\`\`\`

Regras adicionais:
- Preserve exatamente os nomes das chaves acima
- Use valores booleanos, numéricos e datas em formato compatível com a estrutura acima
- Quando um campo opcional não puder ser preenchido com segurança, omita-o ou use null somente se isso não comprometer a estrutura
- Os textos de "description", "details", "rationale", "amountBenefit", "calculationBasis" e "impact" devem ser sempre texto puro e legível para exibição direta em cards do sistema`,
    }),
    new PaymentPlanPaidResourceIaConfigEntity({
      paymentPlanPaidResource: findPaymentPlanPaidResourceByType(
...
\`\`\`
{
  ...
  "insuredQualityStatus": "CONFIRMED",
  "applicableRules": [
    {
      "ruleName": "Salário-Maternidade",
      "result": "Texto curto e objetivo, sem markdown, indicando o resultado da regra.",
      "estimatedBenefit": "Texto curto e objetivo, sem markdown, com o valor estimado quando houver.",
      "detailedAnalysis": "Markdown permitido aqui, com análise detalhada da regra, fundamentos e observações relevantes para o último step."
    }
  ],
  "analysisDescription": "Markdown permitido aqui. Use parágrafos bem organizados para a seção Resultados da Análise do último step.",
  "completeAnalysisDownload": "Markdown técnico completo, com títulos, subtítulos, listas e fundamentação jurídica, próprio para geração do documento final."
}
\`\`\`

Regras adicionais:
- Preserve exatamente os nomes das chaves acima
- "ruleName", "result" e "estimatedBenefit" devem ser texto simples, sem markdown
- "analysisDescription" pode usar markdown leve, pois será renderizado no último step
- "completeAnalysisDownload" deve ser o relatório técnico completo em markdown
- Não inclua texto fora da estrutura acima`,
    }),
    new PaymentPlanPaidResourceIaConfigEntity({
      paymentPlanPaidResource: findPaymentPlanPaidResourceByType(
