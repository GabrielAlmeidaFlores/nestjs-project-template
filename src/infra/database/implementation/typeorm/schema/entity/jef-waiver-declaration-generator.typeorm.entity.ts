...
export class JefWaiverDeclarationGeneratorTypeormEntity extends BaseTypeormEntity {
  @Column({ name: 'jef_waiver_declaration_generator_complete_analysis', type: 'text', nullable: true })
  public jefWaiverDeclarationGeneratorCompleteAnalysis: string | null;

  protected override readonly _type = JefWaiverDeclarationGeneratorTypeormEntity.name;
}
