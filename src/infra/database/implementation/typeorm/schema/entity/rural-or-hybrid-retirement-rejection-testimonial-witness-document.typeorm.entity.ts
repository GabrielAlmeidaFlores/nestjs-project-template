...
@Entity({ name: 'rural_or_hybrid_retirement_rejection_testimonial_witness_document' })
export class RuralOrHybridRetirementRejectionTestimonialWitnessDocumentTypeormEntity extends BaseTypeormEntity {
  ...
  @ManyToOne(
    ...
    (entity) => entity.ruralOrHybridRetirementRejectionTestimonialWitnessDocument,
  )
  @JoinColumn({ name: 'rural_or_hybrid_retirement_rejection_testimonial_witness_id' })
