...
export class RuralOrHybridRetirementRejectionWorkPeriodTypeormEntity extends BaseTypeormEntity {
  ...
  @Column({ name: 'contribution_average', type: 'varchar', length: 255, nullable: true })
  ...
  @Column({ name: 'job_type', type: 'simple-enum', enum: RuralOrHybridRetirementRejectionWorkPeriodJobTypeEnum, nullable: true })
