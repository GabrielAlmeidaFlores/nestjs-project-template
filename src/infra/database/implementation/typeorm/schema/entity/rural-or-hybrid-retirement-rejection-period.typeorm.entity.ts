...
export class RuralOrHybridRetirementRejectionPeriodTypeormEntity extends BaseTypeormEntity {
  ...
  @Column({ name: 'worker_type', type: 'simple-enum', enum: RuralOrHybridRetirementRejectionWorkerTypeEnum, nullable: true })
  public workerType: RuralOrHybridRetirementRejectionWorkerTypeEnum | null;

  @Column({ name: 'work_schedule', type: 'simple-enum', enum: RuralOrHybridRetirementRejectionWorkScheduleEnum, nullable: true })
  ...
  @Column({ name: 'property_category', type: 'varchar', length: 255, nullable: true })
  public propertyCategory: string | null;

  @Column({ name: 'property_owner', type: 'varchar', length: 255, nullable: true })
  ...
  @Column({ name: 'property_state', type: 'simple-enum', enum: StateCodeEnum, nullable: true })
  public propertyState: StateCodeEnum | null;

  @Column({ name: 'property_city', type: 'varchar', length: 255, nullable: true })
  public propertyCity: string | null;

  @Column({ name: 'property_neighbourhood', type: 'varchar', length: 255, nullable: true })
  public propertyNeighbourhood: string | null;

  @Column({ name: 'property_street', type: 'varchar', length: 255, nullable: true })
  public propertyStreet: string | null;

  @Column({ name: 'property_number', type: 'varchar', length: 50, nullable: true })
  public propertyNumber: string | null;

  @Column({ name: 'production_destination', type: 'simple-enum', enum: RuralOrHybridRetirementRejectionProductionDestinationEnum, nullable: true })
  ...
  @Column({ name: 'agricultural_machinery_description', type: 'longtext', nullable: true })
  ...
  @Column({ name: 'farm_vehicles_description', type: 'longtext', nullable: true })
  public farmVehiclesDescription: string | null;

  @Column({ name: 'income_besides_rural_production', type: 'boolean', nullable: true })
  public incomeBesidesRuralProduction: boolean | null;

  @Column({ name: 'income_besides_rural_production_description', type: 'longtext', nullable: true })
  ...
  @Column({ name: 'client_has_or_had_cnpj_description', type: 'longtext', nullable: true })
  public clientHasOrHadCnpjDescription: string | null;

  @Column({ name: 'client_lives_in_urban_area', type: 'boolean', nullable: true })
  public clientLivesInUrbanArea: boolean | null;

  @Column({ name: 'client_municipality', type: 'varchar', length: 255, nullable: true })
  public clientMunicipality: string | null;

  @Column({ name: 'client_state', type: 'simple-enum', enum: StateCodeEnum, nullable: true })
