...
@Entity({ name: 'analysis_tool_client_interview_form' })
export class AnalysisToolClientInterviewFormTypeormEntity extends BaseTypeormEntity {
  ...
  @Column({ name: 'is_married', type: 'boolean', nullable: true })
  ...
  protected override readonly _type = AnalysisToolClientInterviewFormTypeormEntity.name;
}
