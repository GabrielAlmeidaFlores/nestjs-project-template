...
export class PovertyDeclarationGeneratorTypeormEntity extends BaseTypeormEntity {
  @Column({ name: 'poverty_declaration_generator_complete_analysis', type: 'text', nullable: true })
  public povertyDeclarationGeneratorCompleteAnalysis: string | null;

  protected override readonly _type = PovertyDeclarationGeneratorTypeormEntity.name;
}
