...
export class SpecialCategoryRetirementAnalysisResultRuleItemTypeormCommandRepository
  ...
  implements SpecialCategoryRetirementAnalysisResultRuleItemCommandRepositoryGateway
{
  protected readonly _type = SpecialCategoryRetirementAnalysisResultRuleItemTypeormCommandRepository.name;
