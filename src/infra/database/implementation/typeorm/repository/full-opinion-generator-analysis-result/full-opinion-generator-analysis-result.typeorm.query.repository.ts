...
@Injectable()
export class FullOpinionGeneratorTypeormQueryRepository
  implements FullOpinionGeneratorQueryRepositoryGateway
{
  protected readonly _type =
    FullOpinionGeneratorTypeormQueryRepository.name;
