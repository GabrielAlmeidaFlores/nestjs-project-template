...
export class SpecialRetirementGrant1775158830724 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (!(await queryRunner.hasTable('special_retirement_grant_benefit'))) {
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_document'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_legal_proceeding'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_earnings_history'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_period_overdue_contribution'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_period_pending_exit_date'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_period_under_minimum'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_period'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant_result'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasTable('special_retirement_grant'))) {
      await queryRunner.query(
    ...
    if (!(await queryRunner.hasColumn('analysis_tool_record', 'special_retirement_grant_id'))) {
      await queryRunner.query(
        `ALTER TABLE \`analysis_tool_record\` ADD \`special_retirement_grant_id\` varchar(36) NULL`,
      );
    }

    const atrTableForIdx = await queryRunner.getTable('analysis_tool_record');

    if (!atrTableForIdx?.indices.find((idx) => idx.name === 'IDX_467461f25aaf1080665789dfd2')) {
      await queryRunner.query(
    ...
    if (!atrTableForIdx?.indices.find((idx) => idx.name === 'REL_467461f25aaf1080665789dfd2')) {
      await queryRunner.query(
        `CREATE UNIQUE INDEX \`REL_467461f25aaf1080665789dfd2\` ON \`analysis_tool_record\` (\`special_retirement_grant_id\`)`,
      );
    }

    const srgBenefitTable = await queryRunner.getTable('special_retirement_grant_benefit');
    if (!srgBenefitTable?.foreignKeys.find((fk) => fk.name === 'FK_87273f80cb3d8a533034bdbe39a')) {
      await queryRunner.query(
    ...
    const srgDocumentTable = await queryRunner.getTable('special_retirement_grant_document');
    if (!srgDocumentTable?.foreignKeys.find((fk) => fk.name === 'FK_ec6dfca9648d553ec4a627260b0')) {
      await queryRunner.query(
    ...
    const srgLegalTable = await queryRunner.getTable('special_retirement_grant_legal_proceeding');
    if (!srgLegalTable?.foreignKeys.find((fk) => fk.name === 'FK_44212508e53e58e4d94701eaf08')) {
      await queryRunner.query(
    ...
    const srgEarningsTable = await queryRunner.getTable('special_retirement_grant_earnings_history');
    if (!srgEarningsTable?.foreignKeys.find((fk) => fk.name === 'FK_88e865d45e3080c9758ccd8b5b3')) {
      await queryRunner.query(
    ...
    if (!srgEarningsTable?.foreignKeys.find((fk) => fk.name === 'FK_4546b5aa86528007d73f4b27a00')) {
      await queryRunner.query(
    ...
    const srgOverdueTable = await queryRunner.getTable('special_retirement_grant_period_overdue_contribution');
    if (!srgOverdueTable?.foreignKeys.find((fk) => fk.name === 'FK_446002bfd1872a7b1711b507bc9')) {
      await queryRunner.query(
    ...
    const srgPendingTable = await queryRunner.getTable('special_retirement_grant_period_pending_exit_date');
    if (!srgPendingTable?.foreignKeys.find((fk) => fk.name === 'FK_c2b1ad6c01749f8d813a194ecc1')) {
      await queryRunner.query(
    ...
    const srgUnderMinTable = await queryRunner.getTable('special_retirement_grant_period_under_minimum');
    if (!srgUnderMinTable?.foreignKeys.find((fk) => fk.name === 'FK_09170fc28c9332b01240fae5a9f')) {
      await queryRunner.query(
    ...
    const srgPeriodTable = await queryRunner.getTable('special_retirement_grant_period');
    if (!srgPeriodTable?.foreignKeys.find((fk) => fk.name === 'FK_ad83a1caadac0a4282ba0661326')) {
      await queryRunner.query(
    ...
    const srgTable = await queryRunner.getTable('special_retirement_grant');
    if (!srgTable?.foreignKeys.find((fk) => fk.name === 'FK_69c55102d01911aab0514d05cf8')) {
      await queryRunner.query(
    ...
    if (!srgTable?.foreignKeys.find((fk) => fk.name === 'FK_8ecdc7efa4f70d22d93db2f7f23')) {
      await queryRunner.query(
    ...
    if (!srgTable?.foreignKeys.find((fk) => fk.name === 'FK_0e6818d3c98421a72e41dad2b4f')) {
      await queryRunner.query(
    ...
    const atrTable = await queryRunner.getTable('analysis_tool_record');
    if (!atrTable?.foreignKeys.find((fk) => fk.name === 'FK_467461f25aaf1080665789dfd26')) {
      await queryRunner.query(
