...
const classProvider: ClassProvider[] = [
  ...
  },
  {
    ...
    useClass: TeacherRetirementPlanningRejectionDocumentTypeormCommandRepository,
  },
  {
    provide: TeacherRetirementPlanningRejectionInssBenefitCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionInssBenefitTypeormCommandRepository,
  },
  {
  ...
  {
    provide: TeacherRetirementPlanningRejectionTeachingPeriodCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionTeachingPeriodTypeormCommandRepository,
  },
  {
    provide: TeacherRetirementPlanningRejectionTeachingPeriodDocumentCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionTeachingPeriodDocumentTypeormCommandRepository,
  },
  {
    provide: TeacherRetirementPlanningRejectionTimeAcceleratorCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionTimeAcceleratorTypeormCommandRepository,
  },
  {
    provide: TeacherRetirementPlanningRejectionWorkPeriodCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionWorkPeriodTypeormCommandRepository,
  },
  {
    provide: TeacherRetirementPlanningRejectionWorkPeriodDocumentCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionWorkPeriodDocumentTypeormCommandRepository,
  },
  {
    provide: TeacherRetirementPlanningRejectionWorkPeriodEarningsHistoryCommandRepositoryGateway,
    useClass: TeacherRetirementPlanningRejectionWorkPeriodEarningsHistoryTypeormCommandRepository,
  },
  {
