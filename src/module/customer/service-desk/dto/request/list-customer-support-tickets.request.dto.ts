...
@RequestDto()
export class ListCustomerSupportTicketsRequestDto extends ListDataRequestDto {
  ...
  protected override readonly _type = ListCustomerSupportTicketsRequestDto.name;
}
