...
@ResponseDto()
export class SendSupportTicketMessageResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(SupportTicketId)
  public supportTicketId: SupportTicketId;

  protected override readonly _type = SendSupportTicketMessageResponseDto.name;
}
