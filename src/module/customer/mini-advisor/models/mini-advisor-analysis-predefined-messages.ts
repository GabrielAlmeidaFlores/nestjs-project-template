...
interface MiniAdvisorAnalysisPredefinedMessage {
  benefitDescription: string;
  attentionNote: string;
}

export class MiniAdvisorAnalysisPredefinedMessages {
  private static readonly messages: Record<
    MiniAdvisorAnalysisTypeEnum,
    MiniAdvisorAnalysisPredefinedMessage
  > = {
  ...
  public static getByType(
    type: MiniAdvisorAnalysisTypeEnum,
  ): MiniAdvisorAnalysisPredefinedMessage {
