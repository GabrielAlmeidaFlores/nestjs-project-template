...
import { CreateCnisFastAnalysisRequestDto } from '@module/customer/analysis-tools/dto/request/create-cnis-fast-analysis.request.dto';
...
import { CreateCnisFastAnalysisResponseDto } from '@module/customer/analysis-tools/dto/response/create-cnis-fast-analysis.response.dto';
...
@CustomerControllerRoute('analysis-tools')
export class AnalysisToolsController {
  protected readonly _type = AnalysisToolsController.name;
