...
import type { CnisFastAnalysisResultEntityPropsInterface } from '@module/customer/analysis-tools/domain/schema/entity/cnis-fast-analysis-result/cnis-fast-analysis-result.entity.props.interface';
