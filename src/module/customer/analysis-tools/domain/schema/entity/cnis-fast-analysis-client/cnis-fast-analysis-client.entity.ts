...
import { InvalidCnisFastAnalysisClientNameError } from '@module/customer/analysis-tools/domain/schema/entity/cnis-fast-analysis-client/error/invalid-cnis-fast-analysis-client-name.error';
import { CnisFastAnalysisClientId } from '@module/customer/analysis-tools/domain/schema/entity/cnis-fast-analysis-client/value-object/cnis-fast-analysis-client-id/cnis-fast-analysis-client-id.value-object';
...
import type { CnisFastAnalysisClientEntityPropsInterface } from '@module/customer/analysis-tools/domain/schema/entity/cnis-fast-analysis-client/cnis-fast-analysis-client.entity.props.interface';
