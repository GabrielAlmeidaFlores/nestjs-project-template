...
@ResponseDto()
export class ListLegalProceedingDetailResponseDto extends ListDataResponseDto<GetLegalProceedingDetailResponseDto> {
  @ResponseDtoObjectProperty(() => GetLegalProceedingDetailResponseDto, {
    isArray: true,
  })
  public override resource: GetLegalProceedingDetailResponseDto[];
