...
@ResponseDto()
export class GetLegalProceedingDetailWithLawyerAndRecipientRelationsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GetLegalProceedingDetailWithLawyerAndRecipientRelationsResponseDto.name;
}
