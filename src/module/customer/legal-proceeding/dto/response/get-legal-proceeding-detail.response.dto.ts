...
@ResponseDto()
export class GetLegalProceedingDetailResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type = GetLegalProceedingDetailResponseDto.name;
}
