...
@ResponseDto()
export class PreviewOrganizationCustomizationDocumentHeaderTemplateResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PreviewOrganizationCustomizationDocumentHeaderTemplateResponseDto.name;
}
