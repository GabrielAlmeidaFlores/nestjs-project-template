...
@ResponseDto()
export class PreviewOrganizationCustomizationDocumentFooterTemplateResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PreviewOrganizationCustomizationDocumentFooterTemplateResponseDto.name;
}
