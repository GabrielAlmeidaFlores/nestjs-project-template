...
@ResponseDto()
export class GetOrganizationCustomizationDocumentHeaderTemplateResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GetOrganizationCustomizationDocumentHeaderTemplateResponseDto.name;
}
