...
@RequestDto()
export class PatchOrganizationCustomizationRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoValueObjectProperty(ColorValue, { required: false })
  ...
  protected override readonly _type =
    PatchOrganizationCustomizationRequestDto.name;
}
