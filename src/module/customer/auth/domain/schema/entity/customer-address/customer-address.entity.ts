...
import { InvalidCityError } from '@module/customer/auth/domain/schema/entity/customer-address/error/invalid-customer-address-city.error';
import { InvalidNeighborhoodError } from '@module/customer/auth/domain/schema/entity/customer-address/error/invalid-customer-address-neighborhood.error';
...
import type { CustomerAddressEntityPropsInterface } from '@module/customer/auth/domain/schema/entity/customer-address/customer-address.entity.props.interface';
