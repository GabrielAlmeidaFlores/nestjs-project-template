...
import { InvalidCustomerNameError } from '@module/customer/auth/domain/schema/entity/customer/error/invalid-customer-name.error';
...
import type { CustomerEntityPropsInterface } from '@module/customer/auth/domain/schema/entity/customer/customer.entity.props.interface';
