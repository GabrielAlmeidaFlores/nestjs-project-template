...
@ResponseDto()
export class ListAnalysisToolClientLegalProceedingWithRelationsResponseDto extends ListDataResponseDto<GetAnalysisToolClientLegalProceedingWithRelationsResponseDto> {
  ...
  protected override readonly _type =
    ListAnalysisToolClientLegalProceedingWithRelationsResponseDto.name;
}
