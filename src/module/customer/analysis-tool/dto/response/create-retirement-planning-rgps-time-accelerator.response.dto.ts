...
@ResponseDto()
export class CreateRetirementPlanningRgpsTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRetirementPlanningRgpsTimeAcceleratorResponseDto.name;
}
