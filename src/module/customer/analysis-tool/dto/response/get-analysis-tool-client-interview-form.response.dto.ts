...
@ResponseDto()
export class GetAnalysisToolClientInterviewFormResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(AnalysisToolClientInterviewFormId, { required: false })
  public id?: AnalysisToolClientInterviewFormId;
  ...
  protected override readonly _type = GetAnalysisToolClientInterviewFormResponseDto.name;
}
