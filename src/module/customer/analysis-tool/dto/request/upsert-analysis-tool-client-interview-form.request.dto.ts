...
@RequestDto()
export class UpsertAnalysisToolClientInterviewFormRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type = UpsertAnalysisToolClientInterviewFormRequestDto.name;
}
