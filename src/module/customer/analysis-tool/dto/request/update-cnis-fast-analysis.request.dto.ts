...
@RequestDto()
export class UpdateAnalysisToolClientRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type = UpdateAnalysisToolClientRequestDto.name;
}
...
export class UpdateCnisFastAnalysisJsonRequestDto extends BaseBuildableDtoObject {
  ...
  public cnisFastAnalysisClient?: UpdateAnalysisToolClientRequestDto;
