...
@RequestDto()
export class DataAnalyzeRetirementPlanningRgpsCnisRequestDto extends BaseBuildableDtoObject {
  @RequestDtoValueObjectProperty(RetirementPlanningRgpsId)
  public retirementPlanningRgpsId: RetirementPlanningRgpsId;

  protected override readonly _type =
    DataAnalyzeRetirementPlanningRgpsCnisRequestDto.name;
}

@RequestDto()
export class AnalyzeRetirementPlanningRgpsCnisRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => DataAnalyzeRetirementPlanningRgpsCnisRequestDto,
  )
  public json: DataAnalyzeRetirementPlanningRgpsCnisRequestDto;

  protected override readonly _type =
    AnalyzeRetirementPlanningRgpsCnisRequestDto.name;
}
