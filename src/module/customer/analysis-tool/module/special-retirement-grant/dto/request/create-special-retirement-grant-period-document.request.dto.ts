...
@RequestDto()
export class CreateSpecialRetirementGrantPeriodDocumentRequestDto extends BaseBuildableDtoObject {
  @RequestDtoEnumProperty(SpecialRetirementGrantPeriodDocumentTypeEnum)
  ...
  protected override readonly _type =
    CreateSpecialRetirementGrantPeriodDocumentRequestDto.name;
}
