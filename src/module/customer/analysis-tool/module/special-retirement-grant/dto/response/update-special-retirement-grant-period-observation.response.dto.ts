...
@ResponseDto()
export class UpdateSpecialRetirementGrantPeriodObservationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateSpecialRetirementGrantPeriodObservationResponseDto.name;
}
