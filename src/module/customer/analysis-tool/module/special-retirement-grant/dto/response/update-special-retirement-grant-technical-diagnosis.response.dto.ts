...
@ResponseDto()
export class UpdateSpecialRetirementGrantTechnicalDiagnosisResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(SpecialRetirementGrantId)
  public specialRetirementGrantId: SpecialRetirementGrantId;

  protected override readonly _type =
    UpdateSpecialRetirementGrantTechnicalDiagnosisResponseDto.name;
}
