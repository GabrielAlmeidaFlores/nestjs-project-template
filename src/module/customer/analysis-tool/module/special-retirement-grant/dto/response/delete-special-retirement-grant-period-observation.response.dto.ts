...
@ResponseDto()
export class DeleteSpecialRetirementGrantPeriodObservationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteSpecialRetirementGrantPeriodObservationResponseDto.name;
}
