  ...
  public async execute(
    ...
    const technicalDiagnosis =
      new SpecialRetirementGrantTechnicalDiagnosisEntity({
        periodStartDate: dto.periodStartDate ?? new Date(),
        periodEndDate: dto.periodEndDate ?? new Date(),
        recognized: dto.recognized ?? false,
        justification: dto.justification ?? '',
        company: dto.company ?? '',
        cnpj: dto.cnpj ?? '',
        role: dto.role ?? '',
        supportingDocument: dto.supportingDocument ?? '',
        recordedInCnis: dto.recordedInCnis ?? false,
        remunerationRecordedInCnis: dto.remunerationRecordedInCnis ?? false,
