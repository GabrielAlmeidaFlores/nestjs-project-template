...
@Injectable()
export class UpdateSpecialRetirementGrantPeriodObservationUseCase {
  protected readonly _type =
    UpdateSpecialRetirementGrantPeriodObservationUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateSpecialRetirementGrantPeriodObservationRequestDto,
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute([
      this.observationCommandRepositoryGateway.deleteAllBySpecialRetirementGrantPeriodId(
        periodId,
      ),
    ...
    return UpdateSpecialRetirementGrantPeriodObservationResponseDto.build({
      specialRetirementGrantPeriodId: periodId,
    });
  }
}
