...
@Injectable()
export class UpdateSpecialRetirementGrantTechnicalDiagnosisUseCase {
  protected readonly _type =
    UpdateSpecialRetirementGrantTechnicalDiagnosisUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateSpecialRetirementGrantTechnicalDiagnosisRequestDto,
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute([
      this.technicalDiagnosisCommandRepositoryGateway.deleteAllBySpecialRetirementGrantId(
        specialRetirementGrantId,
      ),
      this.technicalDiagnosisCommandRepositoryGateway.updateSpecialRetirementGrantTechnicalDiagnosis(
        technicalDiagnosis,
      ),
    ]);
    ...
    return UpdateSpecialRetirementGrantTechnicalDiagnosisResponseDto.build({
      specialRetirementGrantId,
    });
  }
}
