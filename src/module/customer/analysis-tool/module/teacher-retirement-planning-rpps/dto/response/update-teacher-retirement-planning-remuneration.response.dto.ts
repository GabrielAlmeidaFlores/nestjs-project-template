...
@ResponseDto()
export class UpdateTeacherRetirementPlanningRemunerationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTeacherRetirementPlanningRemunerationResponseDto.name;
}
