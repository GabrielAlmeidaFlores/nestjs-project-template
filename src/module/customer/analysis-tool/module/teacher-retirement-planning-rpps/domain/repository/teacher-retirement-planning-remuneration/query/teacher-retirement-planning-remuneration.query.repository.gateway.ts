...
import type { ListTeacherRetirementPlanningRppsRemunerationQueryParam } from '@module/customer/analysis-tool/module/teacher-retirement-planning-rpps/domain/repository/teacher-retirement-planning-remuneration/query/param/list-teacher-retirement-planning-remuneration.query.param';
...
export abstract class TeacherRetirementPlanningRppsRemunerationQueryRepositoryGateway {
  public abstract findByTeacherRetirementPlanningId(
    teacherRetirementPlanningId: TeacherRetirementPlanningRppsId,
  ): Promise<GetTeacherRetirementPlanningRppsRemunerationQueryResult[]>;

  public abstract listByTeacherRetirementPlanningIdAndOrganizationIdAndAuthIdentityId(
    organizationId: OrganizationId,
    authIdentityId: AuthIdentityId,
    teacherRetirementPlanningId: TeacherRetirementPlanningRppsId,
    listData: ListTeacherRetirementPlanningRppsRemunerationQueryParam,
  ): Promise<
    ListDataOutputModel<GetTeacherRetirementPlanningRppsRemunerationQueryResult>
  >;
}
