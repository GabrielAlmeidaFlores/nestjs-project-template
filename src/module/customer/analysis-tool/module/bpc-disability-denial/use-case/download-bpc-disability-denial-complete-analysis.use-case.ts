...
@Injectable()
export class DownloadBpcDisabilityDenialCompleteAnalysisUseCase {
  protected readonly _type =
    DownloadBpcDisabilityDenialCompleteAnalysisUseCase.name;
  ...
  public async execute(
    ...
    if (bpcDisabilityDenialQueryResult.bpcDisabilityDenialResult === null) {
