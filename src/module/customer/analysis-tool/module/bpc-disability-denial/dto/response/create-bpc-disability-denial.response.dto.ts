...
@ResponseDto()
export class CreateBpcDisabilityDenialResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcDisabilityDenialId)
  public readonly bpcDisabilityDenialId: BpcDisabilityDenialId;

  protected override readonly _type = CreateBpcDisabilityDenialResponseDto.name;
}
