...
@ResponseDto()
export class UpdateBpcDisabilityDenialResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcDisabilityDenialId)
  public readonly bpcDisabilityDenialId: BpcDisabilityDenialId;

  protected override readonly _type = UpdateBpcDisabilityDenialResponseDto.name;
}
