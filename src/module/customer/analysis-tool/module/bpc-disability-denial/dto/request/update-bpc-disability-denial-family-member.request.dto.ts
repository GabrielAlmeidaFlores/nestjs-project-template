...
@RequestDto()
export class UpdateBpcDisabilityDenialFamilyMemberDocumentRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateBpcDisabilityDenialFamilyMemberDocumentRequestDto.name;
}

@RequestDto()
export class UpdateBpcDisabilityDenialFamilyMemberItemRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => UpdateBpcDisabilityDenialFamilyMemberDocumentRequestDto,
    {
      required: false,
      isArray: true,
    },
  )
  public readonly documents?: UpdateBpcDisabilityDenialFamilyMemberDocumentRequestDto[];

  protected override readonly _type =
    UpdateBpcDisabilityDenialFamilyMemberItemRequestDto.name;
}

@RequestDto()
export class UpdateBpcDisabilityDenialFamilyMemberRequestDto extends BaseBuildableDtoObject {
  @RequestDtoObjectProperty(
    () => UpdateBpcDisabilityDenialFamilyMemberItemRequestDto,
    {
      required: true,
      isArray: true,
    },
  )
  public readonly familyMembers: UpdateBpcDisabilityDenialFamilyMemberItemRequestDto[];

  protected override readonly _type =
    UpdateBpcDisabilityDenialFamilyMemberRequestDto.name;
}
