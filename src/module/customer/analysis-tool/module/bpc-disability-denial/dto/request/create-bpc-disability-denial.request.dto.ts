...
@RequestDto()
export class CreateBpcDisabilityDenialRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoEnumProperty(BpcDisabilityDenialCategoryEnum, {
    required: false,
  })
  ...
  protected override readonly _type = CreateBpcDisabilityDenialRequestDto.name;
}
