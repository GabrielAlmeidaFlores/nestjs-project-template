...
@Injectable()
export class CreateInsuranceQualityAnalysisUseCase {
  protected readonly _type = CreateInsuranceQualityAnalysisUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateInsuranceQualityAnalysisRequestDto,
    ...
    await this.createOnDatabase(insuranceQualityAnalysis, analysisToolRecord);

    return CreateInsuranceQualityAnalysisResponseDto.build({
      insuranceQualityAnalysisId: insuranceQualityAnalysis.id,
    });
  }
  ...
  private async createOnDatabase(
    ...
    const insuranceQualityAnalysisTransaction =
      this.insuranceQualityAnalysisCommandRepositoryGateway.createInsuranceQualityAnalysis(
        insuranceQualityAnalysis,
      );
