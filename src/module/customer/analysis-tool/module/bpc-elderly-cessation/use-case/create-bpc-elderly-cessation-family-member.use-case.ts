...
@Injectable()
export class CreateBpcElderlyCessationFamilyMemberUseCase {
  protected readonly _type = CreateBpcElderlyCessationFamilyMemberUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateBpcElderlyCessationFamilyMemberRequestDto,
    ...
    return CreateBpcElderlyCessationFamilyMemberResponseDto.build({
