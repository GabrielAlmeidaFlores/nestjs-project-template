...
import type { GetBpcElderlyCessationDocumentQueryResult } from '@module/customer/analysis-tool/module/bpc-elderly-cessation/domain/repository/bpc-elderly-cessation/query/result/get-bpc-elderly-cessation-document.query.result';
import type { GetBpcElderlyCessationFamilyMemberQueryResult } from '@module/customer/analysis-tool/module/bpc-elderly-cessation/domain/repository/bpc-elderly-cessation/query/result/get-bpc-elderly-cessation-family-member.query.result';
import type { GetBpcElderlyCessationInssBenefitQueryResult } from '@module/customer/analysis-tool/module/bpc-elderly-cessation/domain/repository/bpc-elderly-cessation-inss-benefit/query/result/get-bpc-elderly-cessation-inss-benefit.query.result';
import type { GetBpcElderlyCessationLegalProceedingQueryResult } from '@module/customer/analysis-tool/module/bpc-elderly-cessation/domain/repository/bpc-elderly-cessation-legal-proceeding/query/result/get-bpc-elderly-cessation-legal-proceeding.query.result';
import type { GetBpcElderlyCessationResultQueryResult } from '@module/customer/analysis-tool/module/bpc-elderly-cessation/domain/repository/bpc-elderly-cessation-result/query/result/get-bpc-elderly-cessation-result.query.result';
...
export class GetBpcElderlyCessationWithRelationsQueryResult extends BaseBuildableObject {
  ...
  public readonly bpcElderlyCessationResult: GetBpcElderlyCessationResultQueryResult | null;
  public readonly bpcElderlyCessationFamilyMember: GetBpcElderlyCessationFamilyMemberQueryResult[];
  public readonly bpcElderlyCessationDocument: GetBpcElderlyCessationDocumentQueryResult[];
  public readonly bpcElderlyCessationInssBenefit: GetBpcElderlyCessationInssBenefitQueryResult[];
  public readonly bpcElderlyCessationLegalProceeding: GetBpcElderlyCessationLegalProceedingQueryResult[];
  public readonly createdAt: Date;
  public readonly updatedAt: Date;
  public readonly deletedAt: Date | null;

  protected override readonly _type =
    GetBpcElderlyCessationWithRelationsQueryResult.name;
}
