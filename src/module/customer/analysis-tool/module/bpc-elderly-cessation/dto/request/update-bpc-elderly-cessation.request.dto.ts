...
@RequestDto()
export class UpdateBpcElderlyCessationRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoEnumProperty(BpcElderlyCessationCategoryEnum, { required: false })
  ...
  protected override readonly _type = UpdateBpcElderlyCessationRequestDto.name;
}
