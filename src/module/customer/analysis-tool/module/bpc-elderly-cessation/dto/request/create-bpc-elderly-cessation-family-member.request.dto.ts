...
@RequestDto()
export class CreateBpcElderlyCessationFamilyMemberDocumentRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateBpcElderlyCessationFamilyMemberDocumentRequestDto.name;
}

@RequestDto()
export class CreateBpcElderlyCessationFamilyMemberItemRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => CreateBpcElderlyCessationFamilyMemberDocumentRequestDto,
    {
      required: false,
      isArray: true,
    },
  )
  public readonly documents?: CreateBpcElderlyCessationFamilyMemberDocumentRequestDto[];

  protected override readonly _type =
    CreateBpcElderlyCessationFamilyMemberItemRequestDto.name;
}

@RequestDto()
export class CreateBpcElderlyCessationFamilyMemberRequestDto extends BaseBuildableDtoObject {
  @RequestDtoObjectProperty(
    () => CreateBpcElderlyCessationFamilyMemberItemRequestDto,
    {
      required: true,
      isArray: true,
    },
  )
  public readonly familyMembers: CreateBpcElderlyCessationFamilyMemberItemRequestDto[];

  protected override readonly _type =
    CreateBpcElderlyCessationFamilyMemberRequestDto.name;
}
