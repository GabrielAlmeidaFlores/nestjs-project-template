...
@ResponseDto()
export class CreateBpcElderlyCessationResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcElderlyCessationId)
  public readonly bpcElderlyCessationId: BpcElderlyCessationId;

  protected override readonly _type = CreateBpcElderlyCessationResponseDto.name;
}
