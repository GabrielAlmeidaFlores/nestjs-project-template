...
@ResponseDto()
export class UpdateBpcElderlyCessationResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcElderlyCessationId)
  public readonly bpcElderlyCessationId: BpcElderlyCessationId;

  protected override readonly _type = UpdateBpcElderlyCessationResponseDto.name;
}
