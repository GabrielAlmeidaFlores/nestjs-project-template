...
@RequestDto()
export class CreateDisabilityAssessmentForBpcAnalysisJsonRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateDisabilityAssessmentForBpcAnalysisJsonRequestDto.name;
}

@RequestDto()
export class CreateDisabilityAssessmentForBpcAnalysisRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => CreateDisabilityAssessmentForBpcAnalysisJsonRequestDto,
  )
  public json: CreateDisabilityAssessmentForBpcAnalysisJsonRequestDto;

  protected override readonly _type =
    CreateDisabilityAssessmentForBpcAnalysisRequestDto.name;
}
