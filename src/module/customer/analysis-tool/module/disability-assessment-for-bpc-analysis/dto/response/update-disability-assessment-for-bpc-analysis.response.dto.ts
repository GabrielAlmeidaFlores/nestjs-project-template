...
@ResponseDto()
export class UpdateDisabilityAssessmentForBpcAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateDisabilityAssessmentForBpcAnalysisResponseDto.name;
}
