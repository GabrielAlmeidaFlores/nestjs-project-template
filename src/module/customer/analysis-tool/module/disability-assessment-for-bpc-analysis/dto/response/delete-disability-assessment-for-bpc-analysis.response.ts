...
@ResponseDto()
export class DeleteDisabilityAssessmentForBpcAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteDisabilityAssessmentForBpcAnalysisResponseDto.name;
}
