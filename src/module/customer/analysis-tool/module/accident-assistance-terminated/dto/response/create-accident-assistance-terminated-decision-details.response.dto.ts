...
@ResponseDto()
export class CreateAccidentAssistanceTerminatedDecisionDetailsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateAccidentAssistanceTerminatedDecisionDetailsResponseDto.name;
}
