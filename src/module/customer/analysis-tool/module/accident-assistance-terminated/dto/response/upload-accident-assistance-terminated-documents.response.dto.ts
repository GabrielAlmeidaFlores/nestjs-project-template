...
@ResponseDto()
export class UploadAccidentAssistanceTerminatedDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadAccidentAssistanceTerminatedDocumentsResponseDto.name;
}
