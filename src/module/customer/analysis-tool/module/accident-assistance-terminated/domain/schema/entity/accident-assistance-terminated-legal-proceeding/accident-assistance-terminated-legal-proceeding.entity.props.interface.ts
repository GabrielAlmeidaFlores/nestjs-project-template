...
export interface AccidentAssistanceTerminatedLegalProceedingEntityPropsInterface
  extends BaseEntityPropsInterface<AccidentAssistanceTerminatedLegalProceedingId> {
