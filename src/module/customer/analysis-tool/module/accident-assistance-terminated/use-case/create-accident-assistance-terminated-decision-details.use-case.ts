...
@Injectable()
export class CreateAccidentAssistanceTerminatedDecisionDetailsUseCase {
  protected readonly _type =
    CreateAccidentAssistanceTerminatedDecisionDetailsUseCase.name;
  ...
  public async execute(
    ...
    const decisionDetails =
      await this.analysisProcessorGateway.getAccidentAssistanceTerminatedDecisionDetails(
    ...
    return CreateAccidentAssistanceTerminatedDecisionDetailsResponseDto.build({
      accidentAssistanceTerminatedId,
    });
  }
}
