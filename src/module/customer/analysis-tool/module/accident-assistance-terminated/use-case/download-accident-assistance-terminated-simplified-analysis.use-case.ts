...
import { AccidentAssistanceTerminatedDoesNotContainSimplifiedAnalysisError } from '@module/customer/analysis-tool/module/accident-assistance-terminated/error/accident-assistance-terminated-does-not-contain-simplified-analysis.error';
...
export class DownloadAccidentAssistanceTerminatedSimplifiedAnalysisUseCase {
  ...
  public async execute(
    ...
    if (responseAi === null) {
      throw new AccidentAssistanceTerminatedDoesNotContainSimplifiedAnalysisError();
    }
