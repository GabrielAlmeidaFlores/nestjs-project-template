...
import { RuralTimelinePeriodPropertyEntityPropsInterface } from '@module/customer/analysis-tool/module/rural-timeline/domain/schema/entity/rural-timeline-period-property/rural-timeline-period-property.entity.props.interface';
...
export class RuralTimelinePeriodPropertyEntity extends BaseEntity<RuralTimelinePeriodPropertyId> {
  ...
  public readonly landOwnershipType: RuralTimelinePeriodLandOwnershipTypeEnum;

  protected readonly _type = RuralTimelinePeriodPropertyEntity.name;

  public constructor(props: RuralTimelinePeriodPropertyEntityPropsInterface) {
    super(RuralTimelinePeriodPropertyId, props);
