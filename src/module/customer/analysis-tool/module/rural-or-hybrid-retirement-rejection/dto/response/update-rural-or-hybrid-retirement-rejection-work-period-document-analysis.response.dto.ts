...
@ResponseDto()
export class UpdateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto.name;
}
