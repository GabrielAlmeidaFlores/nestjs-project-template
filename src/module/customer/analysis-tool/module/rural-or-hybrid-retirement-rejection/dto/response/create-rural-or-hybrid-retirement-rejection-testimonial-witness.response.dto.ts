...
@ResponseDto()
export class CreateRuralOrHybridRetirementRejectionTestimonialWitnessResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementRejectionTestimonialWitnessResponseDto.name;
}
