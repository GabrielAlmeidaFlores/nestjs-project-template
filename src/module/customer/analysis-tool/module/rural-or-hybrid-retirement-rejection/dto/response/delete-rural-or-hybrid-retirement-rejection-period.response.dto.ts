...
@ResponseDto()
export class DeleteRuralOrHybridRetirementRejectionPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementRejectionPeriodResponseDto.name;
}
