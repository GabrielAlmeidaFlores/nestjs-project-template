...
@ResponseDto()
export class UpdateRuralOrHybridRetirementRejectionTestimonialWitnessResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementRejectionTestimonialWitnessResponseDto.name;
}
