...
@ResponseDto()
export class UpdateRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto.name;
}
