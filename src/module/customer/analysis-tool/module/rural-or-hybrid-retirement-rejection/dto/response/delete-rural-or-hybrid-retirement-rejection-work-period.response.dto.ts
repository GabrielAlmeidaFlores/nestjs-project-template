...
@ResponseDto()
export class DeleteRuralOrHybridRetirementRejectionWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementRejectionWorkPeriodResponseDto.name;
}
