...
@ResponseDto()
export class DeleteRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto.name;
}
