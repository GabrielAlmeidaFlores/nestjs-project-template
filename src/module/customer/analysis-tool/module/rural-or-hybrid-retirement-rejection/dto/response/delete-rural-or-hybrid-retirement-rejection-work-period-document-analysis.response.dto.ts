...
@ResponseDto()
export class DeleteRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto.name;
}
