...
@ResponseDto()
export class CreateRuralOrHybridRetirementRejectionWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementRejectionWorkPeriodResponseDto.name;
}
