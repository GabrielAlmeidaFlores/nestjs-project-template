...
@ResponseDto()
export class CreateRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto.name;
}
