...
@ResponseDto()
export class CreateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto.name;
}
