...
@ResponseDto()
export class DeleteRuralOrHybridRetirementRejectionPeriodMemberResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementRejectionPeriodMemberResponseDto.name;
}
