...
@ResponseDto()
export class CreateRuralOrHybridRetirementRejectionPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementRejectionPeriodResponseDto.name;
}
