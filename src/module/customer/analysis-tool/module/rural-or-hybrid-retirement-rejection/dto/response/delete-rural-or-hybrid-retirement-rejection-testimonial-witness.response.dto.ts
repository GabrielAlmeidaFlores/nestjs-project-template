...
@ResponseDto()
export class DeleteRuralOrHybridRetirementRejectionTestimonialWitnessResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementRejectionTestimonialWitnessResponseDto.name;
}
