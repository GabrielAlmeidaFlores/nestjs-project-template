...
@ResponseDto()
export class UpdateRuralOrHybridRetirementRejectionPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementRejectionPeriodResponseDto.name;
}
