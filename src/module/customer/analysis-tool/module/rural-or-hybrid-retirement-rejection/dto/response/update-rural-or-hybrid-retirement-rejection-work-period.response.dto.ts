...
@ResponseDto()
export class UpdateRuralOrHybridRetirementRejectionWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementRejectionWorkPeriodResponseDto.name;
}
