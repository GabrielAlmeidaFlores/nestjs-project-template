...
@ResponseDto()
export class UpdateRuralOrHybridRetirementRejectionPeriodMemberResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementRejectionPeriodMemberResponseDto.name;
}
