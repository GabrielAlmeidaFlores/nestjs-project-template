...
import {
  CreateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisRequestDto,
  RuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisItemRequestDto,
} from '@module/customer/analysis-tool/module/rural-or-hybrid-retirement-rejection/dto/request/create-rural-or-hybrid-retirement-rejection-work-period-document-analysis.request.dto';
...
@Injectable()
export class CreateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisUseCase {
  protected readonly _type =
    CreateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisUseCase.name;
  ...
  public async execute(
    ...
    const transactions: TransactionType[] = dto.documentAnalyses.map(
      (documentAnalysisDto) =>
    ...
    return CreateRuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisResponseDto.build(
      {
        ruralOrHybridRetirementRejectionId,
      },
    );
