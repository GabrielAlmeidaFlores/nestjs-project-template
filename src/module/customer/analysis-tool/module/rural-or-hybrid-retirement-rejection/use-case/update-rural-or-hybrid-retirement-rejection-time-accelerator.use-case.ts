...
@Injectable()
export class UpdateRuralOrHybridRetirementRejectionTimeAcceleratorUseCase {
  protected readonly _type =
    UpdateRuralOrHybridRetirementRejectionTimeAcceleratorUseCase.name;
  ...
  public async execute(
    ...
    return UpdateRuralOrHybridRetirementRejectionTimeAcceleratorResponseDto.build(
      {
        ruralOrHybridRetirementRejectionId,
      },
    );
