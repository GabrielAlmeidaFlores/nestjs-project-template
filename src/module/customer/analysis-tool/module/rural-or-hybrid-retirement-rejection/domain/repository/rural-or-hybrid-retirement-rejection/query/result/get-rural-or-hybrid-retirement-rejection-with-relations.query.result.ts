...
export class GetRuralOrHybridRetirementRejectionWithRelationsQueryResult extends BaseBuildableObject {
  ...
  public readonly ruralOrHybridRetirementRejectionDocument: RuralOrHybridRetirementRejectionDocumentEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionInssBenefit: RuralOrHybridRetirementRejectionInssBenefitEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionLegalProceeding: RuralOrHybridRetirementRejectionLegalProceedingEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionPeriod: RuralOrHybridRetirementRejectionPeriodEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionPeriodDocument: RuralOrHybridRetirementRejectionPeriodDocumentEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionPeriodMember: RuralOrHybridRetirementRejectionPeriodMemberEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionPeriodMemberDocument: RuralOrHybridRetirementRejectionPeriodMemberDocumentEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionTestimonialWitness: RuralOrHybridRetirementRejectionTestimonialWitnessEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionTestimonialWitnessDocument: RuralOrHybridRetirementRejectionTestimonialWitnessDocumentEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionWorkPeriod: RuralOrHybridRetirementRejectionWorkPeriodEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionWorkPeriodDocument: RuralOrHybridRetirementRejectionWorkPeriodDocumentEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionWorkPeriodDocumentAnalysis: RuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionWorkPeriodEarningsHistory: RuralOrHybridRetirementRejectionWorkPeriodEarningsHistoryEntity[] | null;
  public readonly ruralOrHybridRetirementRejectionTimeAccelerator: RuralOrHybridRetirementRejectionTimeAcceleratorEntity[] | null;
