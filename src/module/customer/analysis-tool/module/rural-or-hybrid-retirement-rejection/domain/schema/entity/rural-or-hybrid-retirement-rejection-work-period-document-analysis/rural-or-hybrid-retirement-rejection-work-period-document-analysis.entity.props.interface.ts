...
export interface RuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisEntityPropsInterface
  extends BaseEntityPropsInterface<RuralOrHybridRetirementRejectionWorkPeriodDocumentAnalysisId> {
