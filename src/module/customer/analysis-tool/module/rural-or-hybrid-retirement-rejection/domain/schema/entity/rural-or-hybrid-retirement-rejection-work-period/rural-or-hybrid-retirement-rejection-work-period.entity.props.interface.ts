...
export interface RuralOrHybridRetirementRejectionWorkPeriodEntityPropsInterface
  extends BaseEntityPropsInterface<RuralOrHybridRetirementRejectionWorkPeriodId> {
