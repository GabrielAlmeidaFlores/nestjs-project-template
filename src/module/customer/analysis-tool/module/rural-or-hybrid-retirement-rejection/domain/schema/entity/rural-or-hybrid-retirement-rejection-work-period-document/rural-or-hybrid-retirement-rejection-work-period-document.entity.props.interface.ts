...
export interface RuralOrHybridRetirementRejectionWorkPeriodDocumentEntityPropsInterface
  extends BaseEntityPropsInterface<RuralOrHybridRetirementRejectionWorkPeriodDocumentId> {
