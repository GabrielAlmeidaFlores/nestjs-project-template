...
export interface RuralOrHybridRetirementRejectionLegalProceedingEntityPropsInterface extends BaseEntityPropsInterface<RuralOrHybridRetirementRejectionLegalProceedingId> {
