...
export interface RuralOrHybridRetirementRejectionInssBenefitEntityPropsInterface
  extends BaseEntityPropsInterface<RuralOrHybridRetirementRejectionInssBenefitId> {
