...
@RequestDto()
export class AnalyzeRuralOrHybridRetirementAnalysisTimeAcceleratorRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    AnalyzeRuralOrHybridRetirementAnalysisTimeAcceleratorRequestDto.name;
}
