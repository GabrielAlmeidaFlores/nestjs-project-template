...
@RequestDto()
export class UpdateRuralOrHybridRetirementAnalysisTestimonialWitnessRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementAnalysisTestimonialWitnessRequestDto.name;
}
