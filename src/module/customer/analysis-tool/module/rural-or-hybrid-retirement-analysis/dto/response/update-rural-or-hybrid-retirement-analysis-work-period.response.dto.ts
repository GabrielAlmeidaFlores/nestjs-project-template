...
@ResponseDto()
export class UpdateRuralOrHybridRetirementAnalysisWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementAnalysisWorkPeriodResponseDto.name;
}
