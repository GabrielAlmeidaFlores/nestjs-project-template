...
@ResponseDto()
export class DeleteRuralOrHybridRetirementAnalysisWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementAnalysisWorkPeriodResponseDto.name;
}
