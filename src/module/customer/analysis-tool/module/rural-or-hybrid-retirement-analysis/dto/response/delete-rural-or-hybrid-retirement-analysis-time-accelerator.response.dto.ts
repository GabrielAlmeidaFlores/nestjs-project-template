...
@ResponseDto()
export class DeleteRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto.name;
}
