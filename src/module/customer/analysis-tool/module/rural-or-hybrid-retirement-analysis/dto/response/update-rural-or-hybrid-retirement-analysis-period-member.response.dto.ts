...
@ResponseDto()
export class UpdateRuralOrHybridRetirementAnalysisPeriodMemberResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementAnalysisPeriodMemberResponseDto.name;
}
