...
@ResponseDto()
export class DeleteRuralOrHybridRetirementAnalysisPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteRuralOrHybridRetirementAnalysisPeriodResponseDto.name;
}
