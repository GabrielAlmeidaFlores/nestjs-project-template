...
@ResponseDto()
export class UpdateRuralOrHybridRetirementAnalysisTestimonialWitnessResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementAnalysisTestimonialWitnessResponseDto.name;
}
