...
@ResponseDto()
export class CreateRuralOrHybridRetirementAnalysisPeriodMemberResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementAnalysisPeriodMemberResponseDto.name;
}
