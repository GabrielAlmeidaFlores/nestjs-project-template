...
@ResponseDto()
export class CreateRuralOrHybridRetirementAnalysisPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementAnalysisPeriodResponseDto.name;
}
