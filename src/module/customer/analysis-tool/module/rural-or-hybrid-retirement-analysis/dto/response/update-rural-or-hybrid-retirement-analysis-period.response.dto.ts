...
@ResponseDto()
export class UpdateRuralOrHybridRetirementAnalysisPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementAnalysisPeriodResponseDto.name;
}
