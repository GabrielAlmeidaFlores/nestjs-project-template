...
@ResponseDto()
export class CreateRuralOrHybridRetirementAnalysisWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementAnalysisWorkPeriodResponseDto.name;
}
