...
@ResponseDto()
export class UpdateRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto.name;
}
