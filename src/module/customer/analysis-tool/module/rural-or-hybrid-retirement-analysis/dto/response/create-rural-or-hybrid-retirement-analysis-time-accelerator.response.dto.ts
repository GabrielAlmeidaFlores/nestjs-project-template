...
@ResponseDto()
export class CreateRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto.name;
}
