...
@ResponseDto()
export class CreateRuralOrHybridRetirementAnalysisTestimonialWitnessResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralOrHybridRetirementAnalysisTestimonialWitnessResponseDto.name;
}
