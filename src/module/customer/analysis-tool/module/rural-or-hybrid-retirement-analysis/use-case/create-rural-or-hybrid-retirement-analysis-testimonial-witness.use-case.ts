...
import {
  CreateRuralOrHybridRetirementAnalysisTestimonialWitnessRequestDto,
  RuralOrHybridRetirementAnalysisTestimonialWitnessItemRequestDto,
} from '@module/customer/analysis-tool/module/rural-or-hybrid-retirement-analysis/dto/request/create-rural-or-hybrid-retirement-analysis-testimonial-witness.request.dto';
...
@Injectable()
export class CreateRuralOrHybridRetirementAnalysisTestimonialWitnessUseCase {
  protected readonly _type =
    CreateRuralOrHybridRetirementAnalysisTestimonialWitnessUseCase.name;
  ...
  public async execute(
    ...
    return CreateRuralOrHybridRetirementAnalysisTestimonialWitnessResponseDto.build(
      {
        ruralOrHybridRetirementAnalysisId,
      },
    );
