...
@Injectable()
export class UpdateRuralOrHybridRetirementAnalysisTimeAcceleratorUseCase {
  protected readonly _type =
    UpdateRuralOrHybridRetirementAnalysisTimeAcceleratorUseCase.name;
  ...
  public async execute(
    ...
    const existingTimeAccelerators =
      existingAnalysis.ruralOrHybridRetirementAnalysisTimeAccelerator ?? [];

    const transactions: TransactionType[] = [
      ...existingTimeAccelerators.map((timeAccelerator) =>
      ...
      ...dto.timeAccelerators.map((timeAcceleratorDto) =>
    ...
    return UpdateRuralOrHybridRetirementAnalysisTimeAcceleratorResponseDto.build(
      {
        ruralOrHybridRetirementAnalysisId,
      },
    );
