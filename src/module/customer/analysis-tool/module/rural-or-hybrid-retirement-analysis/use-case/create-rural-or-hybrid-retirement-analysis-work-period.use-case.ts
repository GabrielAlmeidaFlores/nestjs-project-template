...
import {
  CreateRuralOrHybridRetirementAnalysisWorkPeriodRequestDto,
...
@Injectable()
export class CreateRuralOrHybridRetirementAnalysisWorkPeriodUseCase {
  protected readonly _type =
    CreateRuralOrHybridRetirementAnalysisWorkPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateRuralOrHybridRetirementAnalysisWorkPeriodRequestDto,
    ...
    return CreateRuralOrHybridRetirementAnalysisWorkPeriodResponseDto.build({
      ruralOrHybridRetirementAnalysisId,
    });
  }
