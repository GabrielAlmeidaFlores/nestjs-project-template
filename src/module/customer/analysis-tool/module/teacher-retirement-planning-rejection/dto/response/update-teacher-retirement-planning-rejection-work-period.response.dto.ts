...
@ResponseDto()
export class UpdateTeacherRetirementPlanningRejectionWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTeacherRetirementPlanningRejectionWorkPeriodResponseDto.name;
}
