...
@ResponseDto()
export class CreateTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto.name;
}
