...
@ResponseDto()
export class UpdateTeacherRetirementPlanningRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTeacherRetirementPlanningRejectionResponseDto.name;
}
