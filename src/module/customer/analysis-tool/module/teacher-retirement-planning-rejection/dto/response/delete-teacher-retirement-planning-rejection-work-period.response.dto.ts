...
@ResponseDto()
export class DeleteTeacherRetirementPlanningRejectionWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteTeacherRetirementPlanningRejectionWorkPeriodResponseDto.name;
}
