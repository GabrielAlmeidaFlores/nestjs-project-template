...
@ResponseDto()
export class SaveTeacherRetirementPlanningRejectionTeachingPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveTeacherRetirementPlanningRejectionTeachingPeriodsResponseDto.name;
}
