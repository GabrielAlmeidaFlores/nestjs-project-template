...
@ResponseDto()
export class UploadTeacherRetirementPlanningRejectionDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadTeacherRetirementPlanningRejectionDocumentsResponseDto.name;
}
