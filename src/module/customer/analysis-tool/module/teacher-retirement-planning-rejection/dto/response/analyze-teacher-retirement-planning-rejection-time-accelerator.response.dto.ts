...
@ResponseDto()
export class AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorItemResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorItemResponseDto.name;
}

@ResponseDto()
export class AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoObjectProperty(
    () =>
      AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorItemResponseDto,
    { isArray: true },
  )
  public timeAccelerators: AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorItemResponseDto[];

  protected override readonly _type =
    AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto.name;
}
