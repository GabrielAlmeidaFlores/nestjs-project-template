...
@ResponseDto()
export class CreateTeacherRetirementPlanningRejectionInssDecisionAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTeacherRetirementPlanningRejectionInssDecisionAnalysisResponseDto.name;
}
