...
@ResponseDto()
export class UpdateTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto.name;
}
