...
@ResponseDto()
export class CreateTeacherRetirementPlanningRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTeacherRetirementPlanningRejectionResponseDto.name;
}
