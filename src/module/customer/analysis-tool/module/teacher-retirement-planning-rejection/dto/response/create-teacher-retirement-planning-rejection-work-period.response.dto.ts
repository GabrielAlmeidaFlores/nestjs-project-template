...
@ResponseDto()
export class CreateTeacherRetirementPlanningRejectionWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTeacherRetirementPlanningRejectionWorkPeriodResponseDto.name;
}
