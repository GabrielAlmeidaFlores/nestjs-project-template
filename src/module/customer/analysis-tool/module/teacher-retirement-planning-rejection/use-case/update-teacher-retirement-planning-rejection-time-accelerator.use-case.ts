...
@Injectable()
export class UpdateTeacherRetirementPlanningRejectionTimeAcceleratorUseCase {
  protected readonly _type =
    UpdateTeacherRetirementPlanningRejectionTimeAcceleratorUseCase.name;
  ...
  public async execute(
    ...
    const transactions: TransactionType[] = [
      ...existingTimeAccelerators.map((ta) =>
        this.teacherRetirementPlanningRejectionTimeAcceleratorCommandRepositoryGateway.deleteTeacherRetirementPlanningRejectionTimeAccelerator(
          new TeacherRetirementPlanningRejectionTimeAcceleratorId(ta.id),
        ),
      ),
      ...dto.timeAccelerators.map((taDto) =>
    ...
    return UpdateTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto.build(
      {
        teacherRetirementPlanningRejectionId,
      },
    );
