...
import {
  AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorItemResponseDto,
  AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto,
} from '@module/customer/analysis-tool/module/teacher-retirement-planning-rejection/dto/response/analyze-teacher-retirement-planning-rejection-time-accelerator.response.dto';
import { InvalidTeacherRetirementPlanningRejectionTimeAcceleratorAnalysisJsonError } from '@module/customer/analysis-tool/module/teacher-retirement-planning-rejection/error/invalid-teacher-retirement-planning-rejection-time-accelerator-analysis-json.error';
...
import type {
  TeacherRetirementPlanningRejectionTimeAcceleratorAnalysisResultInterface,
  TeacherRetirementPlanningRejectionTimeAcceleratorAnalysisResultItemInterface,
} from '@module/customer/analysis-tool/module/teacher-retirement-planning-rejection/interface/teacher-retirement-planning-rejection-time-accelerator-analysis-result.interface';

@Injectable()
export class AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorUseCase {
  protected readonly _type =
    AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorUseCase.name;
  ...
  public async execute(
    ...
    return AnalyzeTeacherRetirementPlanningRejectionTimeAcceleratorResponseDto.build(
      {
        timeAccelerators: parsedResult.timeAccelerators.map(
          (
            timeAccelerator: TeacherRetirementPlanningRejectionTimeAcceleratorAnalysisResultItemInterface,
          ) =>
  ...
  private parseAnalysisResult(
    ...
    if (analysisResult === null) {
      throw new InvalidTeacherRetirementPlanningRejectionTimeAcceleratorAnalysisJsonError();
    }
  ...
  private isAnalysisResult(
    value: unknown,
  ): value is TeacherRetirementPlanningRejectionTimeAcceleratorAnalysisResultInterface {
  ...
  private isAnalysisResultItem(
    value: unknown,
  ): value is TeacherRetirementPlanningRejectionTimeAcceleratorAnalysisResultItemInterface {
