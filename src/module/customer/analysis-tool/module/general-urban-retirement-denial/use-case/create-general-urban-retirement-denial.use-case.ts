...
@Injectable()
export class CreateGeneralUrbanRetirementDenialUseCase {
  protected readonly _type = CreateGeneralUrbanRetirementDenialUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateGeneralUrbanRetirementDenialRequestDto,
    ...
    const analysisToolRecord = new AnalysisToolRecordEntity({
      ...
      type: AnalysisToolRecordTypeEnum.GENERAL_URBAN_RETIREMENT_DENIAL,
    ...
    return CreateGeneralUrbanRetirementDenialResponseDto.build({
      generalUrbanRetirementDenialId: generalUrbanRetirementDenial.id,
    });
  }
