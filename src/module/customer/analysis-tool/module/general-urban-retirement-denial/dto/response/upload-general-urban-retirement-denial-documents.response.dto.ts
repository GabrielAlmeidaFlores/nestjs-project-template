...
@ResponseDto()
export class UploadGeneralUrbanRetirementDenialDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadGeneralUrbanRetirementDenialDocumentsResponseDto.name;
}
