...
@ResponseDto()
export class DeleteGeneralUrbanRetirementDenialTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteGeneralUrbanRetirementDenialTimeAcceleratorResponseDto.name;
}
