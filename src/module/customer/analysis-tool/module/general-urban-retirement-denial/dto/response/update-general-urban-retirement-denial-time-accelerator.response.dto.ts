...
@ResponseDto()
export class UpdateGeneralUrbanRetirementDenialTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateGeneralUrbanRetirementDenialTimeAcceleratorResponseDto.name;
}
