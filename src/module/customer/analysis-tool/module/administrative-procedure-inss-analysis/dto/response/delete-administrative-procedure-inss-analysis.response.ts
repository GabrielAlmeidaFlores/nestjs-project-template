...
@ResponseDto()
export class DeleteAdministrativeProcedureInssAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteAdministrativeProcedureInssAnalysisResponseDto.name;
}
