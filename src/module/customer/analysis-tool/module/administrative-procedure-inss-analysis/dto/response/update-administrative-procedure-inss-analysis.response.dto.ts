...
@ResponseDto()
export class UpdateAdministrativeProcedureInssAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateAdministrativeProcedureInssAnalysisResponseDto.name;
}
