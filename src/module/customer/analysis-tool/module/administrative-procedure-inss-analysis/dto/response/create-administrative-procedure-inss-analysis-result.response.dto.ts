...
@ResponseDto()
export class CreateAdministrativeProcedureInssAnalysisResultResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateAdministrativeProcedureInssAnalysisResultResponseDto.name;
}
