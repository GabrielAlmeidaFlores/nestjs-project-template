...
import { TemporaryIncapacityBenefitRejectionDisabilityAnalysisNotFoundError } from '@module/customer/analysis-tool/module/temporary-incapacity-benefit-rejection/error/temporary-incapacity-benefit-rejection-disability-analysis-not-found.error';
...
@Injectable()
export class UpdateTemporaryIncapacityBenefitRejectionDisabilityAnalysisUseCase {
  protected readonly _type =
    UpdateTemporaryIncapacityBenefitRejectionDisabilityAnalysisUseCase.name;
  ...
  public async execute(
    ...
    if (queryResult.disabilityAnalysis.length === 0) {
      throw new TemporaryIncapacityBenefitRejectionDisabilityAnalysisNotFoundError();
    }
    ...
    return UpdateTemporaryIncapacityBenefitRejectionDisabilityAnalysisResponseDto.build(
      {
        temporaryIncapacityBenefitRejectionId,
      },
    );
