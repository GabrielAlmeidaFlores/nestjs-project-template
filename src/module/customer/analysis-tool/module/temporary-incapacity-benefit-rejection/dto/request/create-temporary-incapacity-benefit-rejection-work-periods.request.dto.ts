...
@RequestDto()
export class CreateTemporaryIncapacityBenefitRejectionWorkPeriodsEarningsHistoryItemRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionWorkPeriodsEarningsHistoryItemRequestDto.name;
}

@RequestDto()
export class CreateTemporaryIncapacityBenefitRejectionWorkPeriodsItemRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () =>
      CreateTemporaryIncapacityBenefitRejectionWorkPeriodsEarningsHistoryItemRequestDto,
    { required: false, isArray: true },
  )
  public earningsHistory?: CreateTemporaryIncapacityBenefitRejectionWorkPeriodsEarningsHistoryItemRequestDto[];

  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionWorkPeriodsItemRequestDto.name;
}

@RequestDto()
export class CreateTemporaryIncapacityBenefitRejectionWorkPeriodsRequestDto extends BaseBuildableDtoObject {
  @RequestDtoObjectProperty(
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionWorkPeriodsRequestDto.name;
}
