...
@RequestDto()
export class CreateTemporaryIncapacityBenefitRejectionRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionRequestDto.name;
}
