...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitRejectionResponseDto.name;
}
