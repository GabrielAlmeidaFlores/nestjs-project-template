...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitRejectionInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitRejectionInsuredStatusResponseDto.name;
}
