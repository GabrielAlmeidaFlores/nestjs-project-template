...
@ResponseDto()
export class UploadTemporaryIncapacityBenefitRejectionDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadTemporaryIncapacityBenefitRejectionDocumentsResponseDto.name;
}
