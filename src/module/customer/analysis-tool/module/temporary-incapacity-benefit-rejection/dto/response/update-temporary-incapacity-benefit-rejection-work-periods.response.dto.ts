...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitRejectionWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitRejectionWorkPeriodsResponseDto.name;
}
