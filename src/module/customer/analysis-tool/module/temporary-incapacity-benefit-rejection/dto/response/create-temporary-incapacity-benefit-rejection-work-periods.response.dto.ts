...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitRejectionWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionWorkPeriodsResponseDto.name;
}
