...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitRejectionDisabilityAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionDisabilityAnalysisResponseDto.name;
}
