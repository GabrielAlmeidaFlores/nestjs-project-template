...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitRejectionInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionInsuredStatusResponseDto.name;
}
