...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitRejectionResponseDto.name;
}
