...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitRejectionDisabilityAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitRejectionDisabilityAnalysisResponseDto.name;
}
