...
export class DeleteSpecialCategoryRetirementAnalysisWorkPeriodUseCase {
  protected readonly _type = DeleteSpecialCategoryRetirementAnalysisWorkPeriodUseCase.name;
  ...
  public async execute(
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute([
      this.periodDocumentCommandRepositoryGateway.deleteAllByWorkPeriodId(workPeriodId),
      this.workPeriodCommandRepositoryGateway.deleteSpecialCategoryRetirementAnalysisWorkPeriod(workPeriodId),
    ]);
