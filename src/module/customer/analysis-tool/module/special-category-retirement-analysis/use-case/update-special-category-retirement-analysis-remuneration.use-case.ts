...
export class UpdateSpecialCategoryRetirementAnalysisRemunerationUseCase {
  protected readonly _type = UpdateSpecialCategoryRetirementAnalysisRemunerationUseCase.name;
  ...
  public async execute(
    ...
    const queryResult = await this.remunerationQueryRepositoryGateway.findOneByIdOrFail(
      remunerationId,
      SpecialCategoryRetirementAnalysisRemunerationNotFoundError,
    );

    const updatedRemuneration = new SpecialCategoryRetirementAnalysisRemunerationEntity({
      id: remunerationId,
      specialCategoryRetirementAnalysisId: queryResult.specialCategoryRetirementAnalysisId,
      remunerationReferenceMonthYear: queryResult.remunerationReferenceMonthYear,
