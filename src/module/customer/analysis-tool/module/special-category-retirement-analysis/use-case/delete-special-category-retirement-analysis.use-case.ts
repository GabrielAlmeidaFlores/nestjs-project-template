...
export class DeleteSpecialCategoryRetirementAnalysisUseCase {
  protected readonly _type =
    DeleteSpecialCategoryRetirementAnalysisUseCase.name;
  ...
  public async execute(
    ...
    const remunerations =
      await this.remunerationQueryRepositoryGateway.listByAnalysisId(id);
    ...
    transactions.push(
      this.specialCategoryRetirementAnalysisCommandRepositoryGateway.deleteSpecialCategoryRetirementAnalysis(
        id,
      ),
    );
