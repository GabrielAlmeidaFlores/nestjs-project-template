...
export class AddSpecialCategoryRetirementAnalysisPeriodDocumentUseCase {
  protected readonly _type = AddSpecialCategoryRetirementAnalysisPeriodDocumentUseCase.name;
  ...
  public async execute(
    ...
    const storedFileExternalName = await this.fileProcessorGateway.uploadFile(fileModel);

    const periodDocument = new SpecialCategoryRetirementAnalysisPeriodDocumentEntity({
      specialCategoryRetirementAnalysisWorkPeriodId: dto.specialCategoryRetirementAnalysisWorkPeriodId,
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute([
      this.periodDocumentCommandRepositoryGateway.createSpecialCategoryRetirementAnalysisPeriodDocument(periodDocument),
    ]);
