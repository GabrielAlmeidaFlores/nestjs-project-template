...
@RequestDto()
export class CreateSpecialCategoryRetirementAnalysisRemunerationBatchRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateSpecialCategoryRetirementAnalysisRemunerationBatchRequestDto.name;
}
