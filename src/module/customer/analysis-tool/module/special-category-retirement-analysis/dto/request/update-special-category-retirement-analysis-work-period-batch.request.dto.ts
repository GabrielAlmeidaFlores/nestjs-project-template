...
@RequestDto()
export class UpdateSpecialCategoryRetirementAnalysisWorkPeriodBatchRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateSpecialCategoryRetirementAnalysisWorkPeriodBatchRequestDto.name;
}
