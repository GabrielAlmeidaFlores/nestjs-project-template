...
@RequestDto()
export class UpdateSpecialCategoryRetirementAnalysisWorkPeriodRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoEnumProperty(SpecialTimeRegistrationTypeEnum, { required: false })
  ...
  protected override readonly _type =
    UpdateSpecialCategoryRetirementAnalysisWorkPeriodRequestDto.name;
}
