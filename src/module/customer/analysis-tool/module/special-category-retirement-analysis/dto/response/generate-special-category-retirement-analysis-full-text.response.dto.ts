...
@ResponseDto()
export class GenerateSpecialCategoryRetirementAnalysisFullTextResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GenerateSpecialCategoryRetirementAnalysisFullTextResponseDto.name;
}
