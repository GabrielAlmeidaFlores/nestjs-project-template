...
@ResponseDto()
export class GetSpecialCategoryRetirementAnalysisRemunerationCalculationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GetSpecialCategoryRetirementAnalysisRemunerationCalculationResponseDto.name;
}
