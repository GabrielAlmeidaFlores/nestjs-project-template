...
@ResponseDto()
export class DeleteSpecialCategoryRetirementAnalysisRemunerationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteSpecialCategoryRetirementAnalysisRemunerationResponseDto.name;
}
