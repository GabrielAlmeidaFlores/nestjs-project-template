...
@ResponseDto()
export class GenerateSpecialCategoryRetirementAnalysisConversionResponseDto extends BaseBuildableDtoObject {
  ...
  public processedItemsCount: number;

  protected override readonly _type =
    GenerateSpecialCategoryRetirementAnalysisConversionResponseDto.name;
}
