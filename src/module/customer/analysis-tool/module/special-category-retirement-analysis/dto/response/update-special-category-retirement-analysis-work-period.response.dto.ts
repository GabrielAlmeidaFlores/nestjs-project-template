...
@ResponseDto()
export class UpdateSpecialCategoryRetirementAnalysisWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateSpecialCategoryRetirementAnalysisWorkPeriodResponseDto.name;
}
