...
@ResponseDto()
export class DeleteSpecialCategoryRetirementAnalysisWorkPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteSpecialCategoryRetirementAnalysisWorkPeriodResponseDto.name;
}
