...
@ResponseDto()
export class UpdateSpecialCategoryRetirementAnalysisWorkPeriodBatchResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateSpecialCategoryRetirementAnalysisWorkPeriodBatchResponseDto.name;
}
