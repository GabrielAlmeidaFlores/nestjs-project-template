...
@ResponseDto()
export class GenerateSpecialCategoryRetirementAnalysisRulesResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GenerateSpecialCategoryRetirementAnalysisRulesResponseDto.name;
}
