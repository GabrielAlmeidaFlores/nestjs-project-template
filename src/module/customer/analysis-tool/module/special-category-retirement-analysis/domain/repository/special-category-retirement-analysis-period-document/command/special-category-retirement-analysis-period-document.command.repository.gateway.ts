...
export abstract class SpecialCategoryRetirementAnalysisPeriodDocumentCommandRepositoryGateway {
  ...
  public abstract deleteAllByWorkPeriodId(
    workPeriodId: import('@module/customer/analysis-tool/module/special-category-retirement-analysis/domain/schema/entity/special-category-retirement-analysis-work-period/value-object/special-category-retirement-analysis-work-period-id/special-category-retirement-analysis-work-period-id.value-object').SpecialCategoryRetirementAnalysisWorkPeriodId,
  ): TransactionType;
}
