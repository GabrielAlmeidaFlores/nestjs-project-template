...
export class SpecialCategoryRetirementAnalysisEntity extends BaseEntity<SpecialCategoryRetirementAnalysisId> {
  ...
  public constructor(props: SpecialCategoryRetirementAnalysisEntityPropsInterface) {
    ...
    this.retirementAnalysisObjectiveType = props.retirementAnalysisObjectiveType ?? null;
    this.publicServiceFederativeEntityName = props.publicServiceFederativeEntityName ?? null;
    this.publicServiceStateAbbreviation = props.publicServiceStateAbbreviation ?? null;
    this.hasConfirmedExposureToHarmfulAgents = props.hasConfirmedExposureToHarmfulAgents;
