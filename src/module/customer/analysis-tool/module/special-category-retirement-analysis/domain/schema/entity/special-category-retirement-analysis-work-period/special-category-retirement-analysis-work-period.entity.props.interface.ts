...
export interface SpecialCategoryRetirementAnalysisWorkPeriodEntityPropsInterface
  extends BaseEntityPropsInterface<SpecialCategoryRetirementAnalysisWorkPeriodId> {
