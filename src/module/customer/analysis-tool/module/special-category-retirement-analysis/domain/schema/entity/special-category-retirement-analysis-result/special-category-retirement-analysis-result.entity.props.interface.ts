...
export interface SpecialCategoryRetirementAnalysisResultEntityPropsInterface
  extends BaseEntityPropsInterface<SpecialCategoryRetirementAnalysisResultId> {
