...
export interface SpecialCategoryRetirementAnalysisResultConversionItemEntityPropsInterface
  extends BaseEntityPropsInterface<SpecialCategoryRetirementAnalysisResultConversionItemId> {
