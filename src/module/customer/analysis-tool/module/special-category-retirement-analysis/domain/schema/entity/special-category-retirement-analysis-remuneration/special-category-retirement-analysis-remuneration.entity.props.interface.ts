...
export interface SpecialCategoryRetirementAnalysisRemunerationEntityPropsInterface
  extends BaseEntityPropsInterface<SpecialCategoryRetirementAnalysisRemunerationId> {
  specialCategoryRetirementAnalysisId: SpecialCategoryRetirementAnalysisId;
  remunerationReferenceMonthYear: Date;
  remunerationGrossAmount?: number | null;
}
