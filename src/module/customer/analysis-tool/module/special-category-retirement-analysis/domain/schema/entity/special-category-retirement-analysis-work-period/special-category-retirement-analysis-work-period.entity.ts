...
export class SpecialCategoryRetirementAnalysisWorkPeriodEntity extends BaseEntity<SpecialCategoryRetirementAnalysisWorkPeriodId> {
  ...
  protected readonly _type = SpecialCategoryRetirementAnalysisWorkPeriodEntity.name;

  public constructor(props: SpecialCategoryRetirementAnalysisWorkPeriodEntityPropsInterface) {
    ...
    this.publicServiceCareerStartDate = props.publicServiceCareerStartDate ?? null;
    ...
    this.effectiveSpecialWorkStartDate = props.effectiveSpecialWorkStartDate ?? null;
    this.effectiveSpecialWorkEndDate = props.effectiveSpecialWorkEndDate ?? null;
  }
}
