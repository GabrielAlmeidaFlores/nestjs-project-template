...
export interface SpecialCategoryRetirementAnalysisPeriodDocumentEntityPropsInterface
  extends BaseEntityPropsInterface<SpecialCategoryRetirementAnalysisPeriodDocumentId> {
