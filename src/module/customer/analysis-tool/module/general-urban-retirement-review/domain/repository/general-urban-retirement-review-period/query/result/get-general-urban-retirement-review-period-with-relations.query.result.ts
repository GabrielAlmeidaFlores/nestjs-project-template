...
export class GetGeneralUrbanRetirementReviewPeriodWithRelationsQueryResult extends BaseBuildableObject {
  ...
  protected override readonly _type =
    GetGeneralUrbanRetirementReviewPeriodWithRelationsQueryResult.name;
}
