...
@RequestDto()
export class ListGeneralUrbanRetirementReviewTimeAcceleratorRequestDto extends ListDataRequestDto {
  ...
  protected override readonly _type =
    ListGeneralUrbanRetirementReviewTimeAcceleratorRequestDto.name;
}
