...
@RequestDto()
export class CreateMultipleGeneralUrbanRetirementReviewPeriodsRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateMultipleGeneralUrbanRetirementReviewPeriodsRequestDto.name;
}
