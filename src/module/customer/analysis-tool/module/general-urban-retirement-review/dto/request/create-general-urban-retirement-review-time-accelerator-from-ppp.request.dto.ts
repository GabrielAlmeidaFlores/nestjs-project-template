...
@RequestDto()
export class DataCreateGeneralUrbanRetirementReviewTimeAcceleratorFromPppRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DataCreateGeneralUrbanRetirementReviewTimeAcceleratorFromPppRequestDto.name;
}

@RequestDto()
export class CreateGeneralUrbanRetirementReviewTimeAcceleratorFromPppRequestDto extends BaseBuildableDtoObject {
  @RequestDtoObjectProperty(
    () =>
      DataCreateGeneralUrbanRetirementReviewTimeAcceleratorFromPppRequestDto,
  )
  public json: DataCreateGeneralUrbanRetirementReviewTimeAcceleratorFromPppRequestDto;

  protected override readonly _type =
    CreateGeneralUrbanRetirementReviewTimeAcceleratorFromPppRequestDto.name;
}
