...
@RequestDto()
export class DataAnalyzeGeneralUrbanRetirementReviewPppRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DataAnalyzeGeneralUrbanRetirementReviewPppRequestDto.name;
}

@RequestDto()
export class AnalyzeGeneralUrbanRetirementReviewPppRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => DataAnalyzeGeneralUrbanRetirementReviewPppRequestDto,
  )
  public json: DataAnalyzeGeneralUrbanRetirementReviewPppRequestDto;

  protected override readonly _type =
    AnalyzeGeneralUrbanRetirementReviewPppRequestDto.name;
}
