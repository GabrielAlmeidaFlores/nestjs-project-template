...
@RequestDto()
export class DataAnalyzeGeneralUrbanRetirementReviewCnisRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DataAnalyzeGeneralUrbanRetirementReviewCnisRequestDto.name;
}

@RequestDto()
export class AnalyzeGeneralUrbanRetirementReviewCnisRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => DataAnalyzeGeneralUrbanRetirementReviewCnisRequestDto,
  )
  public json: DataAnalyzeGeneralUrbanRetirementReviewCnisRequestDto;

  protected override readonly _type =
    AnalyzeGeneralUrbanRetirementReviewCnisRequestDto.name;
}
