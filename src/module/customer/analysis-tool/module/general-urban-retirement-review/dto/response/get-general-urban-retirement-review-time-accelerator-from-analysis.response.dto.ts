...
@ResponseDto()
export class GetGeneralUrbanRetirementReviewTimeAcceleratorFromAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GetGeneralUrbanRetirementReviewTimeAcceleratorFromAnalysisResponseDto.name;
}
