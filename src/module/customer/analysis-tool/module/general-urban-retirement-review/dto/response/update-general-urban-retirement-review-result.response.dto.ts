...
@ResponseDto()
export class UpdateGeneralUrbanRetirementReviewResultResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateGeneralUrbanRetirementReviewResultResponseDto.name;
}
