...
@ResponseDto()
export class CreateMultipleGeneralUrbanRetirementReviewPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateMultipleGeneralUrbanRetirementReviewPeriodsResponseDto.name;
}
