...
@ResponseDto()
export class UpdateGeneralUrbanRetirementReviewPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateGeneralUrbanRetirementReviewPeriodResponseDto.name;
}
