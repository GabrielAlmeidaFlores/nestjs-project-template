...
@ResponseDto()
export class DeleteGeneralUrbanRetirementReviewTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteGeneralUrbanRetirementReviewTimeAcceleratorResponseDto.name;
}
