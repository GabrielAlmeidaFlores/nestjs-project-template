...
@ResponseDto()
export class ListGeneralUrbanRetirementReviewPeriodResponseDto extends ListDataResponseDto<GetGeneralUrbanRetirementReviewPeriodResponseDto> {
  ...
  public override resource: GetGeneralUrbanRetirementReviewPeriodResponseDto[];

  protected override readonly _type =
    ListGeneralUrbanRetirementReviewPeriodResponseDto.name;
}
