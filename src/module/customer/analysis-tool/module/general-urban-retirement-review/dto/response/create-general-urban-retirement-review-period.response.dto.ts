...
@ResponseDto()
export class CreateGeneralUrbanRetirementReviewPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateGeneralUrbanRetirementReviewPeriodResponseDto.name;
}
