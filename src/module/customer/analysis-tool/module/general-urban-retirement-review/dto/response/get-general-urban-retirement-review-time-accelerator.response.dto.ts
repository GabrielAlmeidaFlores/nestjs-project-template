...
@ResponseDto()
export class GetGeneralUrbanRetirementReviewTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(GeneralUrbanRetirementReviewTimeAcceleratorId)
  public id: GeneralUrbanRetirementReviewTimeAcceleratorId;
  ...
  protected override readonly _type =
    GetGeneralUrbanRetirementReviewTimeAcceleratorResponseDto.name;
}
