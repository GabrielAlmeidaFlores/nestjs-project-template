...
@Injectable()
export class GetGeneralUrbanRetirementReviewPeriodEarningsWithoutLeaveDateUseCase {
  protected readonly _type =
    GetGeneralUrbanRetirementReviewPeriodEarningsWithoutLeaveDateUseCase.name;
  ...
  public async execute(
    ...
    if (
      ...
      period.reasonPendency !== ReasonPendencyEnum.LEAVE_DATE
    ) {
      return [];
    }
