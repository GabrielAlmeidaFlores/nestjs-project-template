...
@ResponseDto()
export class UpdateBpcElderlyAnalysisResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcElderlyAnalysisId)
  public readonly bpcElderlyAnalysisId: BpcElderlyAnalysisId;

  protected override readonly _type = UpdateBpcElderlyAnalysisResponseDto.name;
}
