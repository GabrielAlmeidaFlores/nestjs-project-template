...
@ResponseDto()
export class SaveBpcDisabilityTerminationDisabilityAssessmentResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveBpcDisabilityTerminationDisabilityAssessmentResponseDto.name;
}
