...
@ResponseDto()
export class SaveBpcDisabilityTerminationFamilyMemberResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveBpcDisabilityTerminationFamilyMemberResponseDto.name;
}
