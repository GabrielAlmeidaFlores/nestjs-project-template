...
@ResponseDto()
export class GetRetirementPlanningRgpsTimeAcceleratorFromAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    GetRetirementPlanningRgpsTimeAcceleratorFromAnalysisResponseDto.name;
}
