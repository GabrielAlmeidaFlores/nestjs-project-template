...
@ResponseDto()
export class CreateMultipleRetirementPlanningRgpsPeriodResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(RetirementPlanningRgpsPeriodId, {
    isArray: true,
  })
  public retirementPlanningRgpsPeriodIds: RetirementPlanningRgpsPeriodId[];

  protected override readonly _type =
    CreateMultipleRetirementPlanningRgpsPeriodResponseDto.name;
}
