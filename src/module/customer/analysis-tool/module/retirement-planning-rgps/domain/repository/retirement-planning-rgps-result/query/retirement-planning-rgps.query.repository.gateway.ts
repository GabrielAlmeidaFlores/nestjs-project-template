...
import type { GetRetirementPlanningRgpsResultQueryResult } from '@module/customer/analysis-tool/module/retirement-planning-rgps/domain/repository/retirement-planning-rgps-result/query/result/get-retirement-planning-rgps-result.query.result';
