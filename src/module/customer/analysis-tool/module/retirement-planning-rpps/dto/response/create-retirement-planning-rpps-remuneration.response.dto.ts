...
@ResponseDto()
export class CreateRetirementPlanningRppsRemunerationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRetirementPlanningRppsRemunerationResponseDto.name;
}
