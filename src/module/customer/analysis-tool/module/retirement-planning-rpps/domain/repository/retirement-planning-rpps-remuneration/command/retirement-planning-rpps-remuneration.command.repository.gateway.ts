...
import type { RetirementPlanningRppsRemunerationEntity } from '@module/customer/analysis-tool/module/retirement-planning-rpps/domain/schema/entity/retirement-planning-rpps-remuneration/retirement-planning-rpps-remuneration.entity';
...
export abstract class RetirementPlanningRppsRemunerationCommandRepositoryGateway {
  ...
  public abstract deleteRetirementPlanningRppsRemuneration(
    id: RetirementPlanningRppsRemunerationId,
  ): TransactionType;
}
