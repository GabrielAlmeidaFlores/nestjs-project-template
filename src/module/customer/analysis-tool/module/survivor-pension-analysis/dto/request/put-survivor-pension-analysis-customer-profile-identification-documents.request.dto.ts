...
@RequestDto()
export class PutSurvivorPensionAnalysisCustomerProfileIdentificationDocumentsRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PutSurvivorPensionAnalysisCustomerProfileIdentificationDocumentsRequestDto.name;
}
