...
@RequestDto()
export class PutSurvivorPensionAnalysisDeceasedBenefitDependentsDocumentsRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PutSurvivorPensionAnalysisDeceasedBenefitDependentsDocumentsRequestDto.name;
}
