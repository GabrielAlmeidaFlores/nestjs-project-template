...
@RequestDto()
export class PutSurvivorPensionAnalysisBenefitOriginatorIdentificationDocumentsRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PutSurvivorPensionAnalysisBenefitOriginatorIdentificationDocumentsRequestDto.name;
}
