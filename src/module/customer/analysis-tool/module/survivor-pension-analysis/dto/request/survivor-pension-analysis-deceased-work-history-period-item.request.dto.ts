...
@RequestDto()
export class SurvivorPensionAnalysisDeceasedWorkHistoryPeriodItemRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SurvivorPensionAnalysisDeceasedWorkHistoryPeriodItemRequestDto.name;
}
