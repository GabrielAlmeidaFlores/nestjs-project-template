...
@ResponseDto()
export class GetSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto extends BaseBuildableDtoObject {
  ...
  @ResponseDtoObjectProperty(
    () =>
      GetSurvivorPensionAnalysisDeceasedBenefitDependentsDocumentResponseDto,
    { isArray: true },
  )
  public documents: GetSurvivorPensionAnalysisDeceasedBenefitDependentsDocumentResponseDto[];
  ...
  protected override readonly _type =
    GetSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto.name;
}
