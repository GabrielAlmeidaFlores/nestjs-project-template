...
@ResponseDto()
export class CreateSurvivorPensionAnalysisResultDependentPensionAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateSurvivorPensionAnalysisResultDependentPensionAnalysisResponseDto.name;
}
