...
@ResponseDto()
export class PutSurvivorPensionAnalysisDeceasedWorkHistoryPeriodDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PutSurvivorPensionAnalysisDeceasedWorkHistoryPeriodDocumentsResponseDto.name;
}
