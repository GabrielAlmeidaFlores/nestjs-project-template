...
@ResponseDto()
export class PutSurvivorPensionAnalysisBenefitOriginatorIdentificationDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    PutSurvivorPensionAnalysisBenefitOriginatorIdentificationDocumentsResponseDto.name;
}
