...
@ResponseDto()
export class PutSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(SurvivorPensionAnalysisId)
  public survivorPensionAnalysisId: SurvivorPensionAnalysisId;

  protected override readonly _type =
    PutSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto.name;
}
