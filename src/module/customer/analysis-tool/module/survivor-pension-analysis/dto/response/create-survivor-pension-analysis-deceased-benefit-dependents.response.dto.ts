...
@ResponseDto()
export class CreateSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto.name;
}
