...
@ResponseDto()
export class DeleteSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteSurvivorPensionAnalysisDeceasedBenefitDependentsResponseDto.name;
}
