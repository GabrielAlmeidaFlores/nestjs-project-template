...
@ResponseDto()
export class UpdateSurvivorPensionAnalysisCustomerProfileIdentificationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateSurvivorPensionAnalysisCustomerProfileIdentificationResponseDto.name;
}
