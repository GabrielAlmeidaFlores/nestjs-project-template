...
@ResponseDto()
export class GetSurvivorPensionAnalysisDeceasedWorkHistoryPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  @ResponseDtoObjectProperty(
    () =>
      GetSurvivorPensionAnalysisDeceasedWorkHistoryPeriodDocumentResponseDto,
    { isArray: true },
  )
  public documents: GetSurvivorPensionAnalysisDeceasedWorkHistoryPeriodDocumentResponseDto[];
  ...
  protected override readonly _type =
    GetSurvivorPensionAnalysisDeceasedWorkHistoryPeriodResponseDto.name;
}
