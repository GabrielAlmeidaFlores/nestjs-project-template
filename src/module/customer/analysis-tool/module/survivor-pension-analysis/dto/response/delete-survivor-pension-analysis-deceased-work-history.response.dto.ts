...
@ResponseDto()
export class DeleteSurvivorPensionAnalysisDeceasedWorkHistoryResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteSurvivorPensionAnalysisDeceasedWorkHistoryResponseDto.name;
}
