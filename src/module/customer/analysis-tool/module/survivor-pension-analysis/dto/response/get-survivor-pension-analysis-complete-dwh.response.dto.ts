...
@ResponseDto()
export class GetSurvivorPensionAnalysisCompleteDwhResponseDto extends BaseBuildableDtoObject {
  ...
  @ResponseDtoObjectProperty(
    () => GetSurvivorPensionAnalysisCompleteDwhPeriodResponseDto,
    { isArray: true },
  )
  public periods: GetSurvivorPensionAnalysisCompleteDwhPeriodResponseDto[];
  ...
  protected override readonly _type =
    GetSurvivorPensionAnalysisCompleteDwhResponseDto.name;
}
