...
@ResponseDto()
export class DeleteSurvivorPensionAnalysisCustomerProfileIdentificationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteSurvivorPensionAnalysisCustomerProfileIdentificationResponseDto.name;
}
