...
@ResponseDto()
export class CreateSurvivorPensionAnalysisDeceasedWorkHistoryPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateSurvivorPensionAnalysisDeceasedWorkHistoryPeriodResponseDto.name;
}
