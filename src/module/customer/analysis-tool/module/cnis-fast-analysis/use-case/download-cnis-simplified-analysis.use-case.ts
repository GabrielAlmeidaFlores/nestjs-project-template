...
import { CnisFastAnalysisDoesNotContainSimplifiedAnalysisError } from '@module/customer/analysis-tool/module/cnis-fast-analysis/error/cnis-fast-analysis-does-not-contain-simplified-analysis.error';
