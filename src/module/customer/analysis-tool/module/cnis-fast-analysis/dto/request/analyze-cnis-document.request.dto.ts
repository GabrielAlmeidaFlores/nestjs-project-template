...
@RequestDto()
export class AnalyzeCnisDocumentJsonRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type = AnalyzeCnisDocumentJsonRequestDto.name;
}

@RequestDto()
export class AnalyzeCnisDocumentRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(() => AnalyzeCnisDocumentJsonRequestDto)
  public json: AnalyzeCnisDocumentJsonRequestDto;

  protected override readonly _type = AnalyzeCnisDocumentRequestDto.name;
}
