...
@Injectable()
export class CreateTemporaryIncapacityBenefitTerminationDisabilityAnalysisUseCase {
  protected readonly _type =
    CreateTemporaryIncapacityBenefitTerminationDisabilityAnalysisUseCase.name;
  ...
  public async execute(
    ...
    return CreateTemporaryIncapacityBenefitTerminationDisabilityAnalysisResponseDto.build(
      {
        temporaryIncapacityBenefitTerminationId,
      },
    );
