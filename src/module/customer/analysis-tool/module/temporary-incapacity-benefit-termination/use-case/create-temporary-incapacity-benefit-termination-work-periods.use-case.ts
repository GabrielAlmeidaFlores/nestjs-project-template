...
import { CreateTemporaryIncapacityBenefitTerminationWorkPeriodsRequestDto } from '@module/customer/analysis-tool/module/temporary-incapacity-benefit-termination/dto/request/create-temporary-incapacity-benefit-termination-work-periods.request.dto';
import { CreateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto } from '@module/customer/analysis-tool/module/temporary-incapacity-benefit-termination/dto/response/create-temporary-incapacity-benefit-termination-work-periods.response.dto';
...
@Injectable()
export class CreateTemporaryIncapacityBenefitTerminationWorkPeriodsUseCase {
  protected readonly _type =
    CreateTemporaryIncapacityBenefitTerminationWorkPeriodsUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateTemporaryIncapacityBenefitTerminationWorkPeriodsRequestDto,
  ): Promise<CreateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto> {
    ...
    return CreateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto.build(
      {
        temporaryIncapacityBenefitTerminationId,
      },
    );
