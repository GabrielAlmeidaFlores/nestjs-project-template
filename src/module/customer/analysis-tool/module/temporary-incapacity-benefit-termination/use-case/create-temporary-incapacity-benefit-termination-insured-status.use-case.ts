...
@Injectable()
export class CreateTemporaryIncapacityBenefitTerminationInsuredStatusUseCase {
  protected readonly _type =
    CreateTemporaryIncapacityBenefitTerminationInsuredStatusUseCase.name;
  ...
  public async execute(
    ...
    return CreateTemporaryIncapacityBenefitTerminationInsuredStatusResponseDto.build(
      {
        temporaryIncapacityBenefitTerminationId,
      },
    );
