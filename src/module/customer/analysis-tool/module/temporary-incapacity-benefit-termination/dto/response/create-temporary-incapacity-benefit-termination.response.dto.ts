...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitTerminationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitTerminationResponseDto.name;
}
