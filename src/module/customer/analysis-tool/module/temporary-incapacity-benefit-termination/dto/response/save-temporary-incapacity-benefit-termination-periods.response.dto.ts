...
@ResponseDto()
export class SaveTemporaryIncapacityBenefitTerminationPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveTemporaryIncapacityBenefitTerminationPeriodsResponseDto.name;
}
