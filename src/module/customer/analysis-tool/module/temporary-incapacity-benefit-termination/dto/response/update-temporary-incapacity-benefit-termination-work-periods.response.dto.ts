...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto.name;
}
