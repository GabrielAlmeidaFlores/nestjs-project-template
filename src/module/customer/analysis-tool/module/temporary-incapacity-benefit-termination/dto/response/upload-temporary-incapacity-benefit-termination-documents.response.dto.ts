...
@ResponseDto()
export class UploadTemporaryIncapacityBenefitTerminationDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadTemporaryIncapacityBenefitTerminationDocumentsResponseDto.name;
}
