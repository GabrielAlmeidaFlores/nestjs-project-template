...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitTerminationWorkPeriodsResponseDto.name;
}
