...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitTerminationInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitTerminationInsuredStatusResponseDto.name;
}
