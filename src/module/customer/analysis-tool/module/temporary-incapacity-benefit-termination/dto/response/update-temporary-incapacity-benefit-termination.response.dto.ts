...
@ResponseDto()
export class UpdateTemporaryIncapacityBenefitTerminationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitTerminationResponseDto.name;
}
