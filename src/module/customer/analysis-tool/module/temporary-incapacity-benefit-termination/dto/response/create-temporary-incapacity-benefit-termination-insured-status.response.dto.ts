...
@ResponseDto()
export class CreateTemporaryIncapacityBenefitTerminationInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryIncapacityBenefitTerminationInsuredStatusResponseDto.name;
}
