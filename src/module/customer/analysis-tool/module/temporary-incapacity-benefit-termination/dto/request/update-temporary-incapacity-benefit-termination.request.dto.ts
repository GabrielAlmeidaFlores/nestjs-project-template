...
@RequestDto()
export class UpdateTemporaryIncapacityBenefitTerminationRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryIncapacityBenefitTerminationRequestDto.name;
}
