...
import type { TemporaryIncapacityBenefitTerminationDisabilityAnalysisEntity } from '@module/customer/analysis-tool/module/temporary-incapacity-benefit-termination/domain/schema/entity/temporary-incapacity-benefit-termination-disability-analysis/temporary-incapacity-benefit-termination-disability-analysis.entity';

export abstract class TemporaryIncapacityBenefitTerminationDisabilityAnalysisCommandRepositoryGateway {
  public abstract createTemporaryIncapacityBenefitTerminationDisabilityAnalysis(
