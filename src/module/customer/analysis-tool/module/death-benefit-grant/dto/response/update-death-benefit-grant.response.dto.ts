...
@ResponseDto()
export class UpdateDeathBenefitGrantResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitGrantId)
  public deathBenefitGrantId: DeathBenefitGrantId;

  protected override readonly _type = UpdateDeathBenefitGrantResponseDto.name;
}
