...
@ResponseDto()
export class CreateDeathBenefitGrantResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitGrantId)
  public deathBenefitGrantId: DeathBenefitGrantId;

  protected override readonly _type = CreateDeathBenefitGrantResponseDto.name;
}
