...
@ResponseDto()
export class UpdateDeathBenefitGrantLegalRepresentativeResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitGrantId)
  public deathBenefitGrantId: DeathBenefitGrantId;

  protected override readonly _type =
    UpdateDeathBenefitGrantLegalRepresentativeResponseDto.name;
}
