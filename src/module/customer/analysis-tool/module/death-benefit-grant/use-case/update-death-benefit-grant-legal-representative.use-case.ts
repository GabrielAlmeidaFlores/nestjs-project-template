...
@Injectable()
export class UpdateDeathBenefitGrantLegalRepresentativeUseCase {
  protected readonly _type =
    UpdateDeathBenefitGrantLegalRepresentativeUseCase.name;
  ...
  public async execute(
    ...
    _dto: UpdateDeathBenefitGrantLegalRepresentativeRequestDto,
    ...
    return UpdateDeathBenefitGrantLegalRepresentativeResponseDto.build({
      deathBenefitGrantId,
    });
  }
}
