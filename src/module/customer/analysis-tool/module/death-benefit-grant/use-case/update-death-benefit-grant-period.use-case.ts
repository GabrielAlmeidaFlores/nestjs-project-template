...
@Injectable()
export class UpdateDeathBenefitGrantPeriodUseCase {
  protected readonly _type = UpdateDeathBenefitGrantPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateDeathBenefitGrantPeriodRequestDto,
    ...
    const existingPeriods =
      existingDeathBenefitGrant.deathBenefitGrantPeriod ?? [];
    const periodIds: DeathBenefitGrantPeriodId[] = [];
    ...
    for (const existingPeriod of existingPeriods) {
      ...
      transactions.push(
        this.deathBenefitGrantPeriodCommandRepositoryGateway.deleteDeathBenefitGrantPeriod(
          existingPeriod.id,
        ),
      );
    }
    ...
    return UpdateDeathBenefitGrantPeriodResponseDto.build({
      deathBenefitGrantId,
    });
  }
}
