...
@ResponseDto()
export class UpdatePermanentIncapacityBenefitTerminatedResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdatePermanentIncapacityBenefitTerminatedResponseDto.name;
}
