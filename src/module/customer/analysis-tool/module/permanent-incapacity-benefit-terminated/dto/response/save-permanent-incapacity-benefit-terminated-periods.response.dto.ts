...
@ResponseDto()
export class SavePermanentIncapacityBenefitTerminatedPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SavePermanentIncapacityBenefitTerminatedPeriodsResponseDto.name;
}
