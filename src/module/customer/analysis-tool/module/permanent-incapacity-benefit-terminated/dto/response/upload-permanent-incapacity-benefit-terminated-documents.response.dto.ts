...
@ResponseDto()
export class UploadPermanentIncapacityBenefitTerminatedDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadPermanentIncapacityBenefitTerminatedDocumentsResponseDto.name;
}
