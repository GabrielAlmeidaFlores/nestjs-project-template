...
@ResponseDto()
export class UpdatePermanentIncapacityBenefitTerminatedInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdatePermanentIncapacityBenefitTerminatedInsuredStatusResponseDto.name;
}
