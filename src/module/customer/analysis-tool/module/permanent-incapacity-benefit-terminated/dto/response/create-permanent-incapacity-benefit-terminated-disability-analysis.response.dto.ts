...
@ResponseDto()
export class CreatePermanentIncapacityBenefitTerminatedDisabilityAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreatePermanentIncapacityBenefitTerminatedDisabilityAnalysisResponseDto.name;
}
