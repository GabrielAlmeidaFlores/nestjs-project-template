...
@ResponseDto()
export class UpdatePermanentIncapacityBenefitTerminatedDisabilityAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdatePermanentIncapacityBenefitTerminatedDisabilityAnalysisResponseDto.name;
}
