...
@ResponseDto()
export class UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto.name;
}
