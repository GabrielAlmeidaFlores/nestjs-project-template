...
@ResponseDto()
export class CreatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto.name;
}
