...
@ResponseDto()
export class CreatePermanentIncapacityBenefitTerminatedResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreatePermanentIncapacityBenefitTerminatedResponseDto.name;
}
