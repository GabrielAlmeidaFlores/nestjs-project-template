...
@RequestDto()
export class CreatePermanentIncapacityBenefitTerminatedRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreatePermanentIncapacityBenefitTerminatedRequestDto.name;
}
