...
import { UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsRequestDto } from '@module/customer/analysis-tool/module/permanent-incapacity-benefit-terminated/dto/request/update-permanent-incapacity-benefit-terminated-work-periods.request.dto';
import { UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto } from '@module/customer/analysis-tool/module/permanent-incapacity-benefit-terminated/dto/response/update-permanent-incapacity-benefit-terminated-work-periods.response.dto';
...
import { PermanentIncapacityBenefitTerminatedWorkPeriodsNotFoundError } from '@module/customer/analysis-tool/module/permanent-incapacity-benefit-terminated/error/permanent-incapacity-benefit-terminated-work-periods-not-found.error';
import { OrganizationSessionDataModel } from '@shared/api/util/decorator/property/get-organization-session-data/model/generic/organization-session-data.model';
import { SessionDataModel } from '@shared/api/util/decorator/property/get-session-data/model/generic/session-data.model';

@Injectable()
export class UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsUseCase {
  protected readonly _type =
    UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsRequestDto,
  ): Promise<UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto> {
    ...
    if (queryResult.workPeriods.length === 0) {
      throw new PermanentIncapacityBenefitTerminatedWorkPeriodsNotFoundError();
    }
    ...
    return UpdatePermanentIncapacityBenefitTerminatedWorkPeriodsResponseDto.build(
      {
        permanentIncapacityBenefitTerminatedId,
      },
    );
