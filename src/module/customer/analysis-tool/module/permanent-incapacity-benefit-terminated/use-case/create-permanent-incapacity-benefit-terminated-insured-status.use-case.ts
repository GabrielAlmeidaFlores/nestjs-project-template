...
@Injectable()
export class CreatePermanentIncapacityBenefitTerminatedInsuredStatusUseCase {
  protected readonly _type =
    CreatePermanentIncapacityBenefitTerminatedInsuredStatusUseCase.name;
  ...
  public async execute(
    ...
    return CreatePermanentIncapacityBenefitTerminatedInsuredStatusResponseDto.build(
      {
        permanentIncapacityBenefitTerminatedId,
      },
    );
