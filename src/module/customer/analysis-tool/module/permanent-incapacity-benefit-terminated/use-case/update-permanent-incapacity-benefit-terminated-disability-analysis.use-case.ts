...
import { PermanentIncapacityBenefitTerminatedDisabilityAnalysisNotFoundError } from '@module/customer/analysis-tool/module/permanent-incapacity-benefit-terminated/error/permanent-incapacity-benefit-terminated-disability-analysis-not-found.error';
...
@Injectable()
export class UpdatePermanentIncapacityBenefitTerminatedDisabilityAnalysisUseCase {
  protected readonly _type =
    UpdatePermanentIncapacityBenefitTerminatedDisabilityAnalysisUseCase.name;
  ...
  public async execute(
    ...
    if (queryResult.disabilityAnalysis.length === 0) {
      throw new PermanentIncapacityBenefitTerminatedDisabilityAnalysisNotFoundError();
    }
    ...
    return UpdatePermanentIncapacityBenefitTerminatedDisabilityAnalysisResponseDto.build(
      {
        permanentIncapacityBenefitTerminatedId,
      },
    );
