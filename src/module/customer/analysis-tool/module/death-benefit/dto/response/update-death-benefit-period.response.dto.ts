...
@ResponseDto()
export class UpdateDeathBenefitPeriodResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitId)
  public deathBenefitId: DeathBenefitId;

  protected override readonly _type = UpdateDeathBenefitPeriodResponseDto.name;
}
