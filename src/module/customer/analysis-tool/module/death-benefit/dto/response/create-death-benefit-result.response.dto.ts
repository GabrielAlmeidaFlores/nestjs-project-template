...
@ResponseDto()
export class CreateDeathBenefitResultResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitId)
  public deathBenefitId: DeathBenefitId;

  protected override readonly _type = CreateDeathBenefitResultResponseDto.name;
}
