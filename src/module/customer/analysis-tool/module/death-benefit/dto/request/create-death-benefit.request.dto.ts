...
@RequestDto()
export class CreateDeathBenefitDocumentRequestDto extends BaseBuildableDtoObject {
  @RequestDtoObjectProperty(() => Base64FileRequestDto)
  public file: Base64FileRequestDto;

  @RequestDtoEnumProperty(DeathBenefitDocumentTypeEnum)
  public type: DeathBenefitDocumentTypeEnum;

  protected override readonly _type = CreateDeathBenefitDocumentRequestDto.name;
}

@RequestDto()
export class CreateDeathBenefitRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type = CreateDeathBenefitRequestDto.name;
}
