...
@Injectable()
export class CreateDeathBenefitResultUseCase {
  protected readonly _type = CreateDeathBenefitResultUseCase.name;
  ...
  public async execute(
    ...
    return CreateDeathBenefitResultResponseDto.build({ deathBenefitId });
  }
}
