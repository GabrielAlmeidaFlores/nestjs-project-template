...
@Injectable()
export class UpdateDeathBenefitLegalRepresentativeUseCase {
  protected readonly _type = UpdateDeathBenefitLegalRepresentativeUseCase.name;
  ...
  public async execute(
    ...
    _dto: UpdateDeathBenefitLegalRepresentativeRequestDto,
    ...
    return UpdateDeathBenefitLegalRepresentativeResponseDto.build({
      deathBenefitId,
    });
  }
}
