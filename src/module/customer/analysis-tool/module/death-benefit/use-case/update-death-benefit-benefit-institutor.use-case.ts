...
@Injectable()
export class UpdateDeathBenefitBenefitInstitorUseCase {
  protected readonly _type = UpdateDeathBenefitBenefitInstitorUseCase.name;
  ...
  public async execute(
    ...
    _dto: UpdateDeathBenefitBenefitInstitorRequestDto,
    ...
    return UpdateDeathBenefitBenefitInstitorResponseDto.build({ deathBenefitId });
  }
}
