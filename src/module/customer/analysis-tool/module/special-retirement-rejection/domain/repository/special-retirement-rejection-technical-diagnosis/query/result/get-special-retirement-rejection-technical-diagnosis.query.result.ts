...
export class GetSpecialRetirementRejectionTechnicalDiagnosisQueryResult extends BaseBuildableObject {
  ...
  protected override readonly _type =
    GetSpecialRetirementRejectionTechnicalDiagnosisQueryResult.name;
}
