...
@ResponseDto()
export class UpdateSpecialRetirementRejectionTechnicalDiagnosisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateSpecialRetirementRejectionTechnicalDiagnosisResponseDto.name;
}
