...
@RequestDto()
export class CreateSpecialRetirementRejectionTechnicalDiagnosisRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateSpecialRetirementRejectionTechnicalDiagnosisRequestDto.name;
}
