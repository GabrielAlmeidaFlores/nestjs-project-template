...
@ResponseDto()
export class UpdateSpeechGeneratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(SpeechGeneratorId)
  public speechGeneratorId: SpeechGeneratorId;

  protected override readonly _type = UpdateSpeechGeneratorResponseDto.name;
}
