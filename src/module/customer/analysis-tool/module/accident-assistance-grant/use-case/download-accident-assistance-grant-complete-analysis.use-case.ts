...
@Injectable()
export class DownloadAccidentAssistanceGrantCompleteAnalysisUseCase {
  protected readonly _type =
    DownloadAccidentAssistanceGrantCompleteAnalysisUseCase.name;
  ...
  public async execute(
    ...
    const analysisText = this.extractField(rawAnalysis, 'firstAnalysis');
    ...
    return this.exportDocumentGateway.downloadFileAsStreamable(
      htmlContent,
      format,
      'analise_completa_concessao_auxilio_acidente',
    );
  }
