...
@RequestDto()
export class CreateAccidentAssistanceGrantDocumentRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateAccidentAssistanceGrantDocumentRequestDto.name;
}

@RequestDto()
export class CreateAccidentAssistanceGrantRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => CreateAccidentAssistanceGrantDocumentRequestDto,
    { required: false, isArray: true },
  )
  public documents?: CreateAccidentAssistanceGrantDocumentRequestDto[];

  protected override readonly _type =
    CreateAccidentAssistanceGrantRequestDto.name;
}
