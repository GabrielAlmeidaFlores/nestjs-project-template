...
@Injectable()
export class CreateBpcDisabilityGrantFamilyMemberUseCase {
  protected readonly _type = CreateBpcDisabilityGrantFamilyMemberUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateBpcDisabilityGrantFamilyMemberRequestDto,
