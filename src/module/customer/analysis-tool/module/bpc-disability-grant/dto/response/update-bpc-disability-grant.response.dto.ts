...
@ResponseDto()
export class UpdateBpcDisabilityGrantResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcDisabilityGrantId)
  public readonly BpcDisabilityGrantId: BpcDisabilityGrantId;

  protected override readonly _type = UpdateBpcDisabilityGrantResponseDto.name;
}
