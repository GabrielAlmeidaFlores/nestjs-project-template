...
@ResponseDto()
export class CreateBpcDisabilityGrantResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(BpcDisabilityGrantId)
  public readonly BpcDisabilityGrantId: BpcDisabilityGrantId;

  protected override readonly _type = CreateBpcDisabilityGrantResponseDto.name;
}
