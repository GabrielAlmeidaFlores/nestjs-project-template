...
export interface AccidentBenefitRejectionWorkPeriodDocumentEntityPropsInterface
  extends BaseEntityPropsInterface<AccidentBenefitRejectionWorkPeriodDocumentId> {
