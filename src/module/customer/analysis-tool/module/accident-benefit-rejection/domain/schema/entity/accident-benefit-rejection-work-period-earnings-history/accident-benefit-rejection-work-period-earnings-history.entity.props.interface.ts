...
export interface AccidentBenefitRejectionWorkPeriodEarningsHistoryEntityPropsInterface
  extends BaseEntityPropsInterface<AccidentBenefitRejectionWorkPeriodEarningsHistoryId> {
