...
export abstract class RuralTimelineAnalysisPeriodDocumentCommandRepositoryGateway {
  public abstract createRuralTimelineAnalysisPeriodDocument(
    props: RuralTimelineAnalysisPeriodDocumentEntity,
  ): TransactionType;

  public abstract updateRuralTimelineAnalysisPeriodDocument(
    props: RuralTimelineAnalysisPeriodDocumentEntity,
  ): TransactionType;

  public abstract deleteRuralTimelineAnalysisPeriodDocument(
