...
export interface RuralTimelineAnalysisPeriodPendingExitDateEntityPropsInterface extends BaseEntityPropsInterface<RuralTimelineAnalysisPeriodPendingExitDateId> {
  pendingDate: Date;
