...
@ResponseDto()
export class UpdateRuralTimelineCnisContributionPeriodDocumentResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralTimelineCnisContributionPeriodDocumentResponseDto.name;
}
