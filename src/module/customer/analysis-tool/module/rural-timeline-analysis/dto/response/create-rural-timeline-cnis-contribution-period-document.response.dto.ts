...
@ResponseDto()
export class CreateRuralTimelineCnisContributionPeriodDocumentResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralTimelineCnisContributionPeriodDocumentResponseDto.name;
}
