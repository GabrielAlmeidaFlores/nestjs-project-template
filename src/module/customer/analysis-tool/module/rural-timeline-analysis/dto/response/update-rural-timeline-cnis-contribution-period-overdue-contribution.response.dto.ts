...
@ResponseDto()
export class UpdateRuralTimelineCnisContributionPeriodOverdueContributionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRuralTimelineCnisContributionPeriodOverdueContributionResponseDto.name;
}
