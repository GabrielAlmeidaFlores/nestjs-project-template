...
@ResponseDto()
export class CreateRuralTimelineAnalysisPeriodResidenceResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralTimelineAnalysisPeriodResidenceResponseDto.name;
}
