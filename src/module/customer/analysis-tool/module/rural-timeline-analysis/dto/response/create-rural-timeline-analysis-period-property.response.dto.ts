...
@ResponseDto()
export class CreateRuralTimelineAnalysisPeriodPropertyResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRuralTimelineAnalysisPeriodPropertyResponseDto.name;
}
