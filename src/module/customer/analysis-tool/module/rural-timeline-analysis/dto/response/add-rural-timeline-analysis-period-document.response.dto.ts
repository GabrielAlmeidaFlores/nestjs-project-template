...
@ResponseDto()
export class AddRuralTimelineAnalysisPeriodDocumentResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(RuralTimelineAnalysisPeriodDocumentId)
  public id: RuralTimelineAnalysisPeriodDocumentId;

  protected override readonly _type =
    AddRuralTimelineAnalysisPeriodDocumentResponseDto.name;
}
