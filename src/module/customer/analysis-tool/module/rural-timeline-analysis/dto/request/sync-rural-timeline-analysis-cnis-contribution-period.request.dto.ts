...
@RequestDto()
export class SyncRuralTimelineAnalysisCnisContributionPeriodRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SyncRuralTimelineAnalysisCnisContributionPeriodRequestDto.name;
}
