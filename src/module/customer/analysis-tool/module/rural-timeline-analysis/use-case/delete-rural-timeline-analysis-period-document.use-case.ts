...
@Injectable()
export class DeleteRuralTimelineAnalysisPeriodDocumentUseCase {
  protected readonly _type =
    DeleteRuralTimelineAnalysisPeriodDocumentUseCase.name;
  ...
  public async execute(
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute([
      this.ruralTimelineAnalysisPeriodDocumentCommandRepositoryGateway.deleteRuralTimelineAnalysisPeriodDocument(
