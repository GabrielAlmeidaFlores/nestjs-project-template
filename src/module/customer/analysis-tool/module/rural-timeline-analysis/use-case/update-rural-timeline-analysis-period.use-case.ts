...
@Injectable()
export class UpdateRuralTimelineAnalysisPeriodUseCase {
  protected readonly _type = UpdateRuralTimelineAnalysisPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateRuralTimelineAnalysisPeriodRequestDto,
    ...
    const updatedEntity = new RuralTimelineAnalysisPeriodEntity({
      id: periodId,
      ruralTimelineId: existingPeriod.ruralTimelineId,
      ruralTimelinePeriodPropertyId:
        existingPeriod.ruralTimelinePeriodPropertyId,
      ruralTimelinePeriodResidenceId:
        existingPeriod.ruralTimelinePeriodResidenceId,
      startDate: dto.startDate ?? existingPeriod.startDate,
      endDate: dto.endDate ?? existingPeriod.endDate,
      workerType: dto.workerType ?? existingPeriod.workerType,
      workRegimeType: dto.workRegimeType ?? existingPeriod.workRegimeType,
      productionDestination:
        dto.productionDestination ?? existingPeriod.productionDestination,
      documentAnalysis: dto.documentAnalysis ?? existingPeriod.documentAnalysis,
      createdAt: existingPeriod.createdAt,
      updatedAt: existingPeriod.updatedAt,
      deletedAt: existingPeriod.deletedAt,
    });
