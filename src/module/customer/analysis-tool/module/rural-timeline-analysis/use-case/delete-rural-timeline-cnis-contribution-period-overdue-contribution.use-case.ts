...
import { DeleteRuralTimelineCnisContributionPeriodOverdueContributionResponseDto } from '@module/customer/analysis-tool/module/rural-timeline-analysis/dto/response/delete-rural-timeline-cnis-contribution-period-overdue-contribution.response.dto';
...
@Injectable()
export class DeleteRuralTimelineCnisContributionPeriodOverdueContributionUseCase {
  protected readonly _type =
    DeleteRuralTimelineCnisContributionPeriodOverdueContributionUseCase.name;
  ...
  public async execute(
  ...
  ): Promise<DeleteRuralTimelineCnisContributionPeriodOverdueContributionResponseDto> {
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute(
      this.ruralTimelineCnisContributionPeriodOverdueContributionCommandRepositoryGateway.deleteRuralTimelineCnisContributionPeriodOverdueContribution(
        overdueContributionId,
      ),
    );
