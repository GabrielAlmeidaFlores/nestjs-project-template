...
@Injectable()
export class CreateRuralTimelineAnalysisPeriodResidenceUseCase {
  protected readonly _type =
    CreateRuralTimelineAnalysisPeriodResidenceUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateRuralTimelineAnalysisPeriodResidenceRequestDto,
    ...
    const residenceEntity = new RuralTimelineAnalysisPeriodResidenceEntity({
      city: dto.city,
      stateCode: dto.stateCode,
      distanceToPropertyKm: dto.distanceToPropertyKm,
    });
    ...
    const updatedPeriod = new RuralTimelineAnalysisPeriodEntity({
      ...
      ruralTimelinePeriodPropertyId: period.ruralTimelinePeriodPropertyId,
      ruralTimelinePeriodResidenceId: residenceEntity.id,
    ...
    const transaction = await this.baseTransactionRepositoryGateway.execute([
      this.ruralTimelineAnalysisPeriodResidenceCommandRepositoryGateway.createRuralTimelineAnalysisPeriodResidence(
        residenceEntity,
      ),
    ...
    return CreateRuralTimelineAnalysisPeriodResidenceResponseDto.build({
      ruralTimelineAnalysisPeriodResidenceId: residenceEntity.id,
    });
  }
}
