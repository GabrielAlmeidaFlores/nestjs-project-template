...
@ResponseDto()
export class CreateRetirementPermanentDisabilityRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRetirementPermanentDisabilityRejectionResponseDto.name;
}
