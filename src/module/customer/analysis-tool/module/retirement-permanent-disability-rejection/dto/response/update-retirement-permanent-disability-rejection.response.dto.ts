...
@ResponseDto()
export class UpdateRetirementPermanentDisabilityRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRetirementPermanentDisabilityRejectionResponseDto.name;
}
