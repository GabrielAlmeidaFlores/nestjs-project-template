...
@ResponseDto()
export class UploadRetirementPermanentDisabilityRejectionDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadRetirementPermanentDisabilityRejectionDocumentsResponseDto.name;
}
