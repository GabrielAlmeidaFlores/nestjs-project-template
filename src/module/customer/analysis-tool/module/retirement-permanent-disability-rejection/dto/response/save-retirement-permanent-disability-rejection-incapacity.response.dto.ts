...
@ResponseDto()
export class SaveRetirementPermanentDisabilityRejectionIncapacityResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveRetirementPermanentDisabilityRejectionIncapacityResponseDto.name;
}
