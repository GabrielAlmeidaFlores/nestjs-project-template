...
@ResponseDto()
export class SaveRetirementPermanentDisabilityRejectionInsuredQualityResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveRetirementPermanentDisabilityRejectionInsuredQualityResponseDto.name;
}
