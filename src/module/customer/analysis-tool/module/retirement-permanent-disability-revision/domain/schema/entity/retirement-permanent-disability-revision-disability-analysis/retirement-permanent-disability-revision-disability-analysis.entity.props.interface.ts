...
export interface RetirementPermanentDisabilityRevisionDisabilityAnalysisEntityPropsInterface
  extends BaseEntityPropsInterface<RetirementPermanentDisabilityRevisionDisabilityAnalysisId> {
