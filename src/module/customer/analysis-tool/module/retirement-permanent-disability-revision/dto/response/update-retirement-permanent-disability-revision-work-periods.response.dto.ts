...
@ResponseDto()
export class UpdateRetirementPermanentDisabilityRevisionWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRetirementPermanentDisabilityRevisionWorkPeriodsResponseDto.name;
}
