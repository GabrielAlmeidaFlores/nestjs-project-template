...
@ResponseDto()
export class UpdateRetirementPermanentDisabilityRevisionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateRetirementPermanentDisabilityRevisionResponseDto.name;
}
