...
@ResponseDto()
export class UploadRetirementPermanentDisabilityRevisionDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadRetirementPermanentDisabilityRevisionDocumentsResponseDto.name;
}
