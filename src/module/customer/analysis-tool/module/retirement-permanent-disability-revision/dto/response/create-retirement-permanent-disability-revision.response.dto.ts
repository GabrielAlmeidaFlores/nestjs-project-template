...
@ResponseDto()
export class CreateRetirementPermanentDisabilityRevisionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRetirementPermanentDisabilityRevisionResponseDto.name;
}
