...
@ResponseDto()
export class CreateRetirementPermanentDisabilityRevisionResultResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRetirementPermanentDisabilityRevisionResultResponseDto.name;
}
