...
@RequestDto()
export class CreateRetirementPermanentDisabilityRevisionResultRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateRetirementPermanentDisabilityRevisionResultRequestDto.name;
}
