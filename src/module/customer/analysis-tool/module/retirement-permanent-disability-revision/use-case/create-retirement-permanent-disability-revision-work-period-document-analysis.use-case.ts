...
@Injectable()
export class CreateRetirementPermanentDisabilityRevisionWorkPeriodDocumentAnalysisUseCase {
  protected readonly _type =
    CreateRetirementPermanentDisabilityRevisionWorkPeriodDocumentAnalysisUseCase.name;
