...
@Injectable()
export class CreateRetirementPermanentDisabilityRevisionWorkPeriodsUseCase {
  protected readonly _type =
    CreateRetirementPermanentDisabilityRevisionWorkPeriodsUseCase.name;
  ...
  public async execute(
    ...
    return CreateRetirementPermanentDisabilityRevisionWorkPeriodsResponseDto.build(
      {
        retirementPermanentDisabilityRevisionId,
      },
    );
