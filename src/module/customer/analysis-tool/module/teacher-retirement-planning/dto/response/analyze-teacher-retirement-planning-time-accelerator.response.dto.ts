...
@ResponseDto()
export class AnalyzeTeacherRetirementPlanningTimeAcceleratorItemResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    AnalyzeTeacherRetirementPlanningTimeAcceleratorItemResponseDto.name;
}

@ResponseDto()
export class AnalyzeTeacherRetirementPlanningTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoObjectProperty(
    () => AnalyzeTeacherRetirementPlanningTimeAcceleratorItemResponseDto,
    { isArray: true },
  )
  public timeAccelerators: AnalyzeTeacherRetirementPlanningTimeAcceleratorItemResponseDto[];

  protected override readonly _type =
    AnalyzeTeacherRetirementPlanningTimeAcceleratorResponseDto.name;
}
