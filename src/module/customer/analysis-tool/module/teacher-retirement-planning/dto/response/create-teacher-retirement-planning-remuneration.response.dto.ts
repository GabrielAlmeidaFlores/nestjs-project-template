...
@ResponseDto()
export class CreateTeacherRetirementPlanningRemunerationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTeacherRetirementPlanningRemunerationResponseDto.name;
}
