...
@RequestDto()
export class AnalyzeTeacherRetirementPlanningTimeAcceleratorRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    AnalyzeTeacherRetirementPlanningTimeAcceleratorRequestDto.name;
}
