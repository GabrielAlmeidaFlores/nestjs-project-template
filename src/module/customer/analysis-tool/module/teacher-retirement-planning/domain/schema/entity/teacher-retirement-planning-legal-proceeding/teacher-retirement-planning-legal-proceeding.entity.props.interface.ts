...
export interface TeacherRetirementPlanningLegalProceedingEntityPropsInterface
  extends BaseEntityPropsInterface<TeacherRetirementPlanningLegalProceedingId> {
