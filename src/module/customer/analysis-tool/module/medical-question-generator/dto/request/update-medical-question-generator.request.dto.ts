...
@RequestDto()
export class UpdateMedicalQuestionGeneratorJsonRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateMedicalQuestionGeneratorJsonRequestDto.name;
}

@RequestDto()
export class UpdateMedicalQuestionGeneratorRequestDto extends BaseBuildableDtoObject {
  @RequestDtoFileProperty({
    allowedMimeType: [MimeTypeEnum.APPLICATION_PDF],
    required: false,
    isArray: true,
  })
  public medicalDocument?: FileModel[];
  ...
  @RequestDtoObjectProperty(() => UpdateMedicalQuestionGeneratorJsonRequestDto)
  public json: UpdateMedicalQuestionGeneratorJsonRequestDto;

  protected override readonly _type =
    UpdateMedicalQuestionGeneratorRequestDto.name;
}
