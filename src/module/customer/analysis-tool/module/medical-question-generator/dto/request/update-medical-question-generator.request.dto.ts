...
@RequestDto()
export class UpdateMedicalQuestionGeneratorDocumentRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateMedicalQuestionGeneratorDocumentRequestDto.name;
}
...
export class UpdateMedicalQuestionGeneratorRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => UpdateMedicalQuestionGeneratorDocumentRequestDto,
    {
      required: false,
      isArray: true,
    },
  )
  public readonly documents?: UpdateMedicalQuestionGeneratorDocumentRequestDto[];
