...
@RequestDto()
export class CreateMedicalQuestionGeneratorJsonRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateMedicalQuestionGeneratorJsonRequestDto.name;
}
...
export class CreateMedicalQuestionGeneratorRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(() => CreateMedicalQuestionGeneratorJsonRequestDto)
  public json: CreateMedicalQuestionGeneratorJsonRequestDto;
