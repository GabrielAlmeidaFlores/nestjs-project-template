...
@Injectable()
export class CreateMaternityPayGrantPeriodUseCase {
  protected readonly _type = CreateMaternityPayGrantPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateMaternityPayGrantPeriodRequestDto,
    ...
    let lastPeriodId = new MaternityPayGrantPeriodId();
    ...
    return CreateMaternityPayGrantPeriodResponseDto.build({
      maternityPayGrantPeriodId: lastPeriodId,
    });
  }
}
