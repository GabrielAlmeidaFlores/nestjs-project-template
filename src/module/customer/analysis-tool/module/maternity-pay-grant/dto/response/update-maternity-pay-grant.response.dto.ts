...
@ResponseDto()
export class UpdateMaternityPayGrantResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(MaternityPayGrantId)
  public maternityPayGrantId: MaternityPayGrantId;

  protected override readonly _type = UpdateMaternityPayGrantResponseDto.name;
}
