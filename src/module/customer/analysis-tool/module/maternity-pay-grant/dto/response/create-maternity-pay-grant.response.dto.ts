...
@ResponseDto()
export class CreateMaternityPayGrantResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(MaternityPayGrantId)
  public maternityPayGrantId: MaternityPayGrantId;

  protected override readonly _type = CreateMaternityPayGrantResponseDto.name;
}
