...
@ResponseDto()
export class UpdateGeneralUrbanRetirementAnalysisPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateGeneralUrbanRetirementAnalysisPeriodResponseDto.name;
}
