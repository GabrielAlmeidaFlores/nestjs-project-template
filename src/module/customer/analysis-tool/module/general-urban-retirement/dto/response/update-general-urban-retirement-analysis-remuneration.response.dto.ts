...
@ResponseDto()
export class UpdateGeneralUrbanRetirementAnalysisRemunerationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateGeneralUrbanRetirementAnalysisRemunerationResponseDto.name;
}
