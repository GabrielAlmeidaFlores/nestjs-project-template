...
@ResponseDto()
export class CreateGeneralUrbanRetirementAnalysisPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateGeneralUrbanRetirementAnalysisPeriodResponseDto.name;
}
