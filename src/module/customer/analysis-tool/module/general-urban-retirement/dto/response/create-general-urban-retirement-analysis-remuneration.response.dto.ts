...
@ResponseDto()
export class CreateGeneralUrbanRetirementAnalysisRemunerationResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateGeneralUrbanRetirementAnalysisRemunerationResponseDto.name;
}
