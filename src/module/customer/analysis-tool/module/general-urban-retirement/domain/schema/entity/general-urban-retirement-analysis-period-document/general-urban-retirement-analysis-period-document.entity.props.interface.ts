...
export interface GeneralUrbanRetirementAnalysisPeriodDocumentEntityPropsInterface
  extends BaseEntityPropsInterface<GeneralUrbanRetirementAnalysisPeriodDocumentId> {
  document: string;
