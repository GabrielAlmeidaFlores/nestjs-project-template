...
import {
  ...
  CreateGeneralUrbanRetirementAnalysisPeriodRequestDto,
...
@Injectable()
export class CreateGeneralUrbanRetirementAnalysisPeriodUseCase {
  protected readonly _type =
    CreateGeneralUrbanRetirementAnalysisPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateGeneralUrbanRetirementAnalysisPeriodRequestDto,
    ...
    return CreateGeneralUrbanRetirementAnalysisPeriodResponseDto.build({
