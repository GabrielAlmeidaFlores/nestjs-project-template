...
@Injectable()
export class CreateDisabilityRetirementPlanningPeriodUseCase {
  protected readonly _type =
    CreateDisabilityRetirementPlanningPeriodUseCase.name;
  ...
  public async execute(
    ...
    return CreateDisabilityRetirementPlanningPeriodsResponseDto.build({
      disabilityRetirementPlanningId,
    });
  }
