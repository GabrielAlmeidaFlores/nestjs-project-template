...
@Injectable()
export class DeleteDisabilityRetirementPlanningUseCase {
  protected readonly _type = DeleteDisabilityRetirementPlanningUseCase.name;
  ...
  public async execute(
    ...
    const deleteTransaction =
      this.disabilityRetirementPlanningCommandRepositoryGateway.deleteDisabilityRetirementPlanning(
        queryResult.id,
      );
    ...
    return DeleteDisabilityRetirementPlanningResponseDto.build({
      disabilityRetirementPlanningId: queryResult.id,
    });
  }
}
