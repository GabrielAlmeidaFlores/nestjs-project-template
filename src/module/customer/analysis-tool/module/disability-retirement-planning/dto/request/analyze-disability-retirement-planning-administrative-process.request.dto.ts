...
@RequestDto()
export class AnalyzeDisabilityRetirementPlanningAdministrativeProcessRequestDto extends BaseBuildableDtoObject {
  @RequestDtoFileProperty({
    allowedMimeType: [MimeTypeEnum.APPLICATION_PDF],
    required: true,
  })
  public administrativeDocuments: FileModel;

  protected override readonly _type =
    AnalyzeDisabilityRetirementPlanningAdministrativeProcessRequestDto.name;
}
