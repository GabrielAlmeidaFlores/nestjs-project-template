...
@ResponseDto()
export class UpdateDisabilityRetirementPlanningPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateDisabilityRetirementPlanningPeriodsResponseDto.name;
}
