...
@ResponseDto()
export class CreateDisabilityRetirementPlanningRemunerationResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DisabilityRetirementPlanningId)
  public readonly disabilityRetirementPlanningId: DisabilityRetirementPlanningId;

  protected override readonly _type =
    CreateDisabilityRetirementPlanningRemunerationResponseDto.name;
}
