...
export interface DisabilityRetirementPlanningLegalProceedingEntityPropsInterface
  extends BaseEntityPropsInterface<DisabilityRetirementPlanningLegalProceedingId> {
