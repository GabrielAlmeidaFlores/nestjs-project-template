...
export interface DisabilityRetirementPlanningPeriodSpecialTimeDocumentEntityPropsInterface
  extends BaseEntityPropsInterface<DisabilityRetirementPlanningPeriodSpecialTimeDocumentId> {
