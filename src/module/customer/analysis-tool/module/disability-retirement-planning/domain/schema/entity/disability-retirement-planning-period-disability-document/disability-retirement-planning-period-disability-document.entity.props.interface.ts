...
export interface DisabilityRetirementPlanningPeriodDisabilityDocumentEntityPropsInterface extends BaseEntityPropsInterface<DisabilityRetirementPlanningPeriodDisabilityDocumentId> {
  disabilityRetirementPlanningPeriodDisability: DisabilityRetirementPlanningPeriodDisabilityEntity;
  document: string;
  type: DisabilityRetirementPlanningPeriodDisabilityDocumentTypeEnum;
}
