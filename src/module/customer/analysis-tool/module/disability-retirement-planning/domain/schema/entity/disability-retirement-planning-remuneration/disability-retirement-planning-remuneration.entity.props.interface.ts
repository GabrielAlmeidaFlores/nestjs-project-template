...
export interface DisabilityRetirementPlanningRemunerationEntityPropsInterface
  extends BaseEntityPropsInterface<DisabilityRetirementPlanningRemunerationId> {
