...
@Injectable()
export class CreateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisUseCase {
  protected readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisUseCase.name;
  ...
  public async execute(
    ...
    return CreateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisResponseDto.build(
      {
        temporaryDisabilityBenefitsTerminatedId,
      },
    );
