...
import { UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsRequestDto } from '@module/customer/analysis-tool/module/temporary-disability-benefits-terminated/dto/request/update-temporary-disability-benefits-terminated-work-periods.request.dto';
import { UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsResponseDto } from '@module/customer/analysis-tool/module/temporary-disability-benefits-terminated/dto/response/update-temporary-disability-benefits-terminated-work-periods.response.dto';
...
import { TemporaryDisabilityBenefitsTerminatedWorkPeriodsNotFoundError } from '@module/customer/analysis-tool/module/temporary-disability-benefits-terminated/error/temporary-disability-benefits-terminated-work-periods-not-found.error';
import { OrganizationSessionDataModel } from '@shared/api/util/decorator/property/get-organization-session-data/model/generic/organization-session-data.model';
import { SessionDataModel } from '@shared/api/util/decorator/property/get-session-data/model/generic/session-data.model';

@Injectable()
export class UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsUseCase {
  protected readonly _type =
    UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsRequestDto,
  ): Promise<UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsResponseDto> {
    ...
    if (queryResult.workPeriods.length === 0) {
      throw new TemporaryDisabilityBenefitsTerminatedWorkPeriodsNotFoundError();
    }
    ...
    return UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsResponseDto.build(
      {
        temporaryDisabilityBenefitsTerminatedId,
      },
    );
