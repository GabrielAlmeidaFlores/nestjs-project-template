...
@RequestDto()
export class CreateTemporaryDisabilityBenefitsTerminatedInsuredStatusDocumentItemRequestDto extends BaseBuildableDtoObject {
  @RequestDtoObjectProperty(() => Base64FileRequestDto)
  public file: Base64FileRequestDto;

  @RequestDtoEnumProperty(
    TemporaryDisabilityBenefitsTerminatedInsuredStatusDocumentTypeEnum,
  )
  public type: TemporaryDisabilityBenefitsTerminatedInsuredStatusDocumentTypeEnum;

  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedInsuredStatusDocumentItemRequestDto.name;
}

@RequestDto()
export class CreateTemporaryDisabilityBenefitsTerminatedInsuredStatusRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedInsuredStatusRequestDto.name;
}
