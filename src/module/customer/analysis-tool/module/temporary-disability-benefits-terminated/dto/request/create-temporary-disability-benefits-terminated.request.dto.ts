...
@RequestDto()
export class CreateTemporaryDisabilityBenefitsTerminatedRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedRequestDto.name;
}
