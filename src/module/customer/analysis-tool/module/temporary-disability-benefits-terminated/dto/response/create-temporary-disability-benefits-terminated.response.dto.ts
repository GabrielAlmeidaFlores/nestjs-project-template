...
@ResponseDto()
export class CreateTemporaryDisabilityBenefitsTerminatedResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedResponseDto.name;
}
