...
@ResponseDto()
export class SaveTemporaryDisabilityBenefitsTerminatedPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveTemporaryDisabilityBenefitsTerminatedPeriodsResponseDto.name;
}
