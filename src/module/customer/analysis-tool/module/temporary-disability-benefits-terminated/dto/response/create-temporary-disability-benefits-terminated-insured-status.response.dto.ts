...
@ResponseDto()
export class CreateTemporaryDisabilityBenefitsTerminatedInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedInsuredStatusResponseDto.name;
}
