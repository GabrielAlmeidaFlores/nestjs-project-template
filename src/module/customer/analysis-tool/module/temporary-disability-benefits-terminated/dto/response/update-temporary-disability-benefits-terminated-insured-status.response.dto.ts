...
@ResponseDto()
export class UpdateTemporaryDisabilityBenefitsTerminatedInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryDisabilityBenefitsTerminatedInsuredStatusResponseDto.name;
}
