...
@ResponseDto()
export class UpdateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisResponseDto.name;
}
