...
@ResponseDto()
export class UploadTemporaryDisabilityBenefitsTerminatedDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadTemporaryDisabilityBenefitsTerminatedDocumentsResponseDto.name;
}
