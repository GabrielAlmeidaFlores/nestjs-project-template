...
@ResponseDto()
export class UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryDisabilityBenefitsTerminatedWorkPeriodsResponseDto.name;
}
