...
@ResponseDto()
export class CreateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsTerminatedDisabilityAnalysisResponseDto.name;
}
