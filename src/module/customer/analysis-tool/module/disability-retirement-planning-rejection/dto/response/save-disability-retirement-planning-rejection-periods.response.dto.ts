...
@ResponseDto()
export class SaveDisabilityRetirementPlanningRejectionPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    SaveDisabilityRetirementPlanningRejectionPeriodsResponseDto.name;
}
