...
@ResponseDto()
export class DeleteDisabilityRetirementPlanningRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteDisabilityRetirementPlanningRejectionTimeAcceleratorResponseDto.name;
}
