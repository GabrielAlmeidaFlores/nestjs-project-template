...
@ResponseDto()
export class UploadDisabilityRetirementPlanningRejectionDocumentsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UploadDisabilityRetirementPlanningRejectionDocumentsResponseDto.name;
}
