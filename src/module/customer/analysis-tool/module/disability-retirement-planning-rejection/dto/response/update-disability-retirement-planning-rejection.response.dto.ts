...
@ResponseDto()
export class UpdateDisabilityRetirementPlanningRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateDisabilityRetirementPlanningRejectionResponseDto.name;
}
