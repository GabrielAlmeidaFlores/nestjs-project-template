...
@ResponseDto()
export class CreateDisabilityRetirementPlanningRejectionResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateDisabilityRetirementPlanningRejectionResponseDto.name;
}
