...
@RequestDto()
export class CreateDisabilityRetirementPlanningRejectionRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateDisabilityRetirementPlanningRejectionRequestDto.name;
}
