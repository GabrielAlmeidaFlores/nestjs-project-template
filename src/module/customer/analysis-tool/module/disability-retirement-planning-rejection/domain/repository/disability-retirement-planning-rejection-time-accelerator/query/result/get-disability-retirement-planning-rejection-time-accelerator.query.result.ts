...
export class GetDisabilityRetirementPlanningRejectionTimeAcceleratorQueryResult extends BaseBuildableObject {
  public readonly id: DisabilityRetirementPlanningRejectionTimeAcceleratorId;
  ...
  protected override readonly _type =
    GetDisabilityRetirementPlanningRejectionTimeAcceleratorQueryResult.name;
}
