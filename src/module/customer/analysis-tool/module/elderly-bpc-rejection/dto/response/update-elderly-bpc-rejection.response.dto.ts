...
@ResponseDto()
export class UpdateElderlyBpcRejectionResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(ElderlyBpcRejectionId)
  public elderlyBpcRejectionId: ElderlyBpcRejectionId;

  protected override readonly _type = UpdateElderlyBpcRejectionResponseDto.name;
}
