...
import { InvalidLegalPleadingApplicationSubmitDateError } from '@module/customer/analysis-tool/module/legal-pleading/domain/schema/entity/legal-pleading/error/invalid-legal-pleading-application-submit-date.error';
import { InvalidLegalPleadingBenefitTerminalDateError } from '@module/customer/analysis-tool/module/legal-pleading/domain/schema/entity/legal-pleading/error/invalid-legal-pleading-bennefit-terminal-date.error';
...
import type { LegalPleadingEntityPropsInterface } from '@module/customer/analysis-tool/module/legal-pleading/domain/schema/entity/legal-pleading/legal-pleading.entity.props.interface';
