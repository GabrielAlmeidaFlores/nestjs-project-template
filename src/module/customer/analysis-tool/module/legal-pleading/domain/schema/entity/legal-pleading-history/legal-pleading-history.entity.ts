...
import type { LegalPleadingHistoryTitleEnum } from '@module/customer/analysis-tool/module/legal-pleading/domain/schema/entity/legal-pleading-history/enum/legal-pleading-history-title.enum';
import type { LegalPleadingHistoryEntityPropsInterface } from '@module/customer/analysis-tool/module/legal-pleading/domain/schema/entity/legal-pleading-history/legal-pleading-history.entity.props.interface';
