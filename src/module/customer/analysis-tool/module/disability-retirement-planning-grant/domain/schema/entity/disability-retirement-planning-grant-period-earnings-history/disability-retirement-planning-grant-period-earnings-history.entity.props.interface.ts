...
export interface DisabilityRetirementPlanningGrantPeriodEarningsHistoryEntityPropsInterface
  extends BaseEntityPropsInterface<DisabilityRetirementPlanningGrantPeriodEarningsHistoryId> {
