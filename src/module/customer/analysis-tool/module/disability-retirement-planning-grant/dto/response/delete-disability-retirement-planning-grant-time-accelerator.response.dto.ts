...
@ResponseDto()
export class DeleteDisabilityRetirementPlanningGrantTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteDisabilityRetirementPlanningGrantTimeAcceleratorResponseDto.name;
}
