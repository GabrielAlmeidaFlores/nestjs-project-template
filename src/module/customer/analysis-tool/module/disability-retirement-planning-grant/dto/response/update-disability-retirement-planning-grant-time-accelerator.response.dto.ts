...
@ResponseDto()
export class UpdateDisabilityRetirementPlanningGrantTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateDisabilityRetirementPlanningGrantTimeAcceleratorResponseDto.name;
}
