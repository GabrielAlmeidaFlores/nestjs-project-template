...
@ResponseDto()
export class UpdateDisabilityRetirementPlanningGrantPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateDisabilityRetirementPlanningGrantPeriodResponseDto.name;
}
