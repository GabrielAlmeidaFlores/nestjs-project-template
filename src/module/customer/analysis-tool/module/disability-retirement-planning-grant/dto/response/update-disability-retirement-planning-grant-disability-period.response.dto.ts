...
@ResponseDto()
export class UpdateDisabilityRetirementPlanningGrantDisabilityPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateDisabilityRetirementPlanningGrantDisabilityPeriodResponseDto.name;
}
