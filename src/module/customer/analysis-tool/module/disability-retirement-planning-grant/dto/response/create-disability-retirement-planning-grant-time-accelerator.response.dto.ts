...
@ResponseDto()
export class CreateDisabilityRetirementPlanningGrantTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateDisabilityRetirementPlanningGrantTimeAcceleratorResponseDto.name;
}
