...
@ResponseDto()
export class DeleteDisabilityRetirementPlanningGrantPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteDisabilityRetirementPlanningGrantPeriodResponseDto.name;
}
