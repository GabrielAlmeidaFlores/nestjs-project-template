...
@ResponseDto()
export class CreateDisabilityRetirementPlanningGrantDisabilityPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateDisabilityRetirementPlanningGrantDisabilityPeriodResponseDto.name;
}
