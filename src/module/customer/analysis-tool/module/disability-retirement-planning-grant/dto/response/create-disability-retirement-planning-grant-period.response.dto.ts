...
@ResponseDto()
export class CreateDisabilityRetirementPlanningGrantPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateDisabilityRetirementPlanningGrantPeriodResponseDto.name;
}
