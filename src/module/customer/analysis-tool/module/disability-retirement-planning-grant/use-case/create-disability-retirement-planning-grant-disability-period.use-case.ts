...
@Injectable()
export class CreateDisabilityRetirementPlanningGrantDisabilityPeriodUseCase {
  protected readonly _type =
    CreateDisabilityRetirementPlanningGrantDisabilityPeriodUseCase.name;
  ...
  public async execute(
    ...
    return CreateDisabilityRetirementPlanningGrantDisabilityPeriodResponseDto.build(
      {
        disabilityRetirementPlanningGrantId,
      },
    );
