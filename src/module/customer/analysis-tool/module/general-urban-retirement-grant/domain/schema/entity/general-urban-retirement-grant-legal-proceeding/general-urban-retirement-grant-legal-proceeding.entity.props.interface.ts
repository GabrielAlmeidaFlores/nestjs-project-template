...
export interface GeneralUrbanRetirementGrantLegalProceedingEntityPropsInterface
  extends BaseEntityPropsInterface<GeneralUrbanRetirementGrantLegalProceedingId> {
