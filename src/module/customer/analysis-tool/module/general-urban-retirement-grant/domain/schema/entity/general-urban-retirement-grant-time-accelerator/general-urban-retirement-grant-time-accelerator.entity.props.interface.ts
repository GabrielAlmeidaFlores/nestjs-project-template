...
export interface GeneralUrbanRetirementGrantTimeAcceleratorEntityPropsInterface
  extends BaseEntityPropsInterface<GeneralUrbanRetirementGrantTimeAcceleratorId> {
  timeType: string;
  name?: string | null;
