...
export interface GeneralUrbanRetirementGrantPeriodDocumentEntityPropsInterface
  extends BaseEntityPropsInterface<GeneralUrbanRetirementGrantPeriodDocumentId> {
  document: string;
