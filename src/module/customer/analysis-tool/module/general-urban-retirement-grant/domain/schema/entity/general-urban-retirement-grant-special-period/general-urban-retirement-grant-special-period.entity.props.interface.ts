...
export interface GeneralUrbanRetirementGrantSpecialPeriodEntityPropsInterface extends BaseEntityPropsInterface<GeneralUrbanRetirementGrantSpecialPeriodId> {
  response: string;
