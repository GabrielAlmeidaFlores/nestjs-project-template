...
export interface GeneralUrbanRetirementGrantAnalysisResultEntityPropsInterface
  extends BaseEntityPropsInterface<GeneralUrbanRetirementGrantAnalysisResultId> {
