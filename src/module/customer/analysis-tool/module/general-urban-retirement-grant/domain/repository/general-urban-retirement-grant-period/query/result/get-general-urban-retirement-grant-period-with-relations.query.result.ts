...
export class GetGeneralUrbanRetirementGrantPeriodWithRelationsQueryResult extends BaseBuildableObject {
  ...
  protected override readonly _type =
    GetGeneralUrbanRetirementGrantPeriodWithRelationsQueryResult.name;
}
