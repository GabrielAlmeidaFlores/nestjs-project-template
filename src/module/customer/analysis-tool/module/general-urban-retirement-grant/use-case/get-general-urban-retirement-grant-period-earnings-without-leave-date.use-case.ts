...
@Injectable()
export class GetGeneralUrbanRetirementGrantPeriodEarningsWithoutLeaveDateUseCase {
  protected readonly _type =
    GetGeneralUrbanRetirementGrantPeriodEarningsWithoutLeaveDateUseCase.name;
