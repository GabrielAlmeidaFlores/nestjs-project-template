...
@ResponseDto()
export class GetGeneralUrbanRetirementGrantPeriodResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(GeneralUrbanRetirementGrantPeriodId)
  public id: GeneralUrbanRetirementGrantPeriodId;
  ...
  protected override readonly _type =
    GetGeneralUrbanRetirementGrantPeriodResponseDto.name;
}
