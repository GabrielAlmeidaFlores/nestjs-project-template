...
@ResponseDto()
export class CreateMultipleGeneralUrbanRetirementGrantPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateMultipleGeneralUrbanRetirementGrantPeriodResponseDto.name;
}
