...
@ResponseDto()
export class DeleteGeneralUrbanRetirementGrantTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DeleteGeneralUrbanRetirementGrantTimeAcceleratorResponseDto.name;
}
