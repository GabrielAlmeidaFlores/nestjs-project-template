...
@ResponseDto()
export class CreateMultipleGeneralUrbanRetirementGrantPeriodsResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(GeneralUrbanRetirementGrantPeriodId, {
    isArray: true,
  })
  public generalUrbanRetirementGrantPeriodIds: GeneralUrbanRetirementGrantPeriodId[];

  protected override readonly _type =
    CreateMultipleGeneralUrbanRetirementGrantPeriodsResponseDto.name;
}
