...
@ResponseDto()
export class GetGeneralUrbanRetirementGrantTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(GeneralUrbanRetirementGrantTimeAcceleratorId)
  public id: GeneralUrbanRetirementGrantTimeAcceleratorId;
  ...
  protected override readonly _type =
    GetGeneralUrbanRetirementGrantTimeAcceleratorResponseDto.name;
}
