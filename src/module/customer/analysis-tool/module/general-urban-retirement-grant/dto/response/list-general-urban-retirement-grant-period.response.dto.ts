...
@ResponseDto()
export class ListGeneralUrbanRetirementGrantPeriodResponseDto extends ListDataResponseDto<GetGeneralUrbanRetirementGrantPeriodResponseDto> {
  ...
  public override resource: GetGeneralUrbanRetirementGrantPeriodResponseDto[];

  protected override readonly _type =
    ListGeneralUrbanRetirementGrantPeriodResponseDto.name;
}
