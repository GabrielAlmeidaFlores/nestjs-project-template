...
@ResponseDto()
export class ConvertGeneralUrbanRetirementGrantSpecialPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    ConvertGeneralUrbanRetirementGrantSpecialPeriodResponseDto.name;
}
