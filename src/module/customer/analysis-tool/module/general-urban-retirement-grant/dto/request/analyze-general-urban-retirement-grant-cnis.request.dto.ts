...
@RequestDto()
export class DataAnalyzeGeneralUrbanRetirementGrantCnisRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    DataAnalyzeGeneralUrbanRetirementGrantCnisRequestDto.name;
}

@RequestDto()
export class AnalyzeGeneralUrbanRetirementGrantCnisRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => DataAnalyzeGeneralUrbanRetirementGrantCnisRequestDto,
  )
  public json: DataAnalyzeGeneralUrbanRetirementGrantCnisRequestDto;

  protected override readonly _type =
    AnalyzeGeneralUrbanRetirementGrantCnisRequestDto.name;
}
