...
@RequestDto()
export class CreateMultipleGeneralUrbanRetirementGrantPeriodsRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateMultipleGeneralUrbanRetirementGrantPeriodsRequestDto.name;
}
