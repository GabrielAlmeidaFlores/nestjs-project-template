...
@Injectable()
export class CreateTemporaryDisabilityBenefitsGrantWorkPeriodsUseCase {
  protected readonly _type =
    CreateTemporaryDisabilityBenefitsGrantWorkPeriodsUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateTemporaryDisabilityBenefitsGrantWorkPeriodsRequestDto,
    ...
    return CreateTemporaryDisabilityBenefitsGrantWorkPeriodsResponseDto.build({
      temporaryDisabilityBenefitsGrantId,
    });
  }
}
