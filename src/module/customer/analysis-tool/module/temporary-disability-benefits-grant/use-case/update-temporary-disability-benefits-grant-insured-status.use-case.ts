...
@Injectable()
export class UpdateTemporaryDisabilityBenefitsGrantInsuredStatusUseCase {
  protected readonly _type =
    UpdateTemporaryDisabilityBenefitsGrantInsuredStatusUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateTemporaryDisabilityBenefitsGrantInsuredStatusRequestDto,
    ...
    const transactions: TransactionType[] = [
      this.temporaryDisabilityBenefitsGrantInsuredStatusCommandRepositoryGateway.deleteAllByTemporaryDisabilityBenefitsGrantId(
        temporaryDisabilityBenefitsGrantId,
      ),
    ...
    return UpdateTemporaryDisabilityBenefitsGrantInsuredStatusResponseDto.build(
      {
        temporaryDisabilityBenefitsGrantId,
      },
    );
