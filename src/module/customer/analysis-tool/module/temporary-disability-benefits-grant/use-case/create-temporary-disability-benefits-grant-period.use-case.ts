...
@Injectable()
export class CreateTemporaryDisabilityBenefitsGrantPeriodUseCase {
  protected readonly _type =
    CreateTemporaryDisabilityBenefitsGrantPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: CreateTemporaryDisabilityBenefitsGrantPeriodRequestDto,
    ...
    return CreateTemporaryDisabilityBenefitsGrantPeriodResponseDto.build({
      temporaryDisabilityBenefitsGrantId,
    });
  }
}
