import { CreateTemporaryDisabilityBenefitsGrantInsuredStatusDocumentItemRequestDto } from '@module/customer/analysis-tool/module/temporary-disability-benefits-grant/dto/request/create-temporary-disability-benefits-grant-insured-status.request.dto';
