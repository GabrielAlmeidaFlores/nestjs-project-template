...
@RequestDto()
export class CreateTemporaryDisabilityBenefitsGrantDocumentRequestDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsGrantDocumentRequestDto.name;
}

@RequestDto()
export class CreateTemporaryDisabilityBenefitsGrantRequestDto extends BaseBuildableDtoObject {
  ...
  @RequestDtoObjectProperty(
    () => CreateTemporaryDisabilityBenefitsGrantDocumentRequestDto,
    { required: false, isArray: true },
  )
  public documents?: CreateTemporaryDisabilityBenefitsGrantDocumentRequestDto[];

  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsGrantRequestDto.name;
}
