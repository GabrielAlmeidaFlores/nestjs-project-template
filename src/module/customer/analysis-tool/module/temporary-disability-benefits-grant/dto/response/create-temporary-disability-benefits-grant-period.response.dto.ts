...
@ResponseDto()
export class CreateTemporaryDisabilityBenefitsGrantPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsGrantPeriodResponseDto.name;
}
