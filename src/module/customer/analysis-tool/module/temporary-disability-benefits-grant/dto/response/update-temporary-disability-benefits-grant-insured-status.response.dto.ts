...
@ResponseDto()
export class UpdateTemporaryDisabilityBenefitsGrantInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryDisabilityBenefitsGrantInsuredStatusResponseDto.name;
}
