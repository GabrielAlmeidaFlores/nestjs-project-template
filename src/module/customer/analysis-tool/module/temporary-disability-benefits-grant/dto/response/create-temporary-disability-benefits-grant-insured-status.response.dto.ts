...
@ResponseDto()
export class CreateTemporaryDisabilityBenefitsGrantInsuredStatusResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsGrantInsuredStatusResponseDto.name;
}
