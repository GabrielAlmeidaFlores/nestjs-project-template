...
@ResponseDto()
export class CreateTemporaryDisabilityBenefitsGrantWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    CreateTemporaryDisabilityBenefitsGrantWorkPeriodsResponseDto.name;
}
