...
@ResponseDto()
export class UpdateTemporaryDisabilityBenefitsGrantWorkPeriodsResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryDisabilityBenefitsGrantWorkPeriodsResponseDto.name;
}
