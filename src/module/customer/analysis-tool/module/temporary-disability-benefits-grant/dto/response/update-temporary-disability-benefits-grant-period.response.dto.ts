...
@ResponseDto()
export class UpdateTemporaryDisabilityBenefitsGrantPeriodResponseDto extends BaseBuildableDtoObject {
  ...
  protected override readonly _type =
    UpdateTemporaryDisabilityBenefitsGrantPeriodResponseDto.name;
}
