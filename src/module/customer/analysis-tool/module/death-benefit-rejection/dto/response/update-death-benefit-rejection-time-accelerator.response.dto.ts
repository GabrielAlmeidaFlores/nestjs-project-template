...
@ResponseDto()
export class UpdateDeathBenefitRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitRejectionId)
  public deathBenefitRejectionId: DeathBenefitRejectionId;

  protected override readonly _type =
    UpdateDeathBenefitRejectionTimeAcceleratorResponseDto.name;
}
