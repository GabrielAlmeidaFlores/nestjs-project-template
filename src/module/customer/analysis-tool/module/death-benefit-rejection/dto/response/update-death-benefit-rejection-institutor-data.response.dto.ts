...
@ResponseDto()
export class UpdateDeathBenefitRejectionInstitutorDataResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitRejectionId)
  public deathBenefitRejectionId: DeathBenefitRejectionId;

  protected override readonly _type =
    UpdateDeathBenefitRejectionInstitutorDataResponseDto.name;
}
