...
@ResponseDto()
export class DeleteDeathBenefitRejectionTimeAcceleratorResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitRejectionId)
  public deathBenefitRejectionId: DeathBenefitRejectionId;

  protected override readonly _type =
    DeleteDeathBenefitRejectionTimeAcceleratorResponseDto.name;
}
