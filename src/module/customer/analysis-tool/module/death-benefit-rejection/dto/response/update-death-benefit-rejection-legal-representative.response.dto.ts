...
@ResponseDto()
export class UpdateDeathBenefitRejectionLegalRepresentativeResponseDto extends BaseBuildableDtoObject {
  @ResponseDtoValueObjectProperty(DeathBenefitRejectionId)
  public deathBenefitRejectionId: DeathBenefitRejectionId;

  protected override readonly _type =
    UpdateDeathBenefitRejectionLegalRepresentativeResponseDto.name;
}
