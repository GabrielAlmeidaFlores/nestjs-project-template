...
@Injectable()
export class UpdateDeathBenefitRejectionPeriodUseCase {
  protected readonly _type = UpdateDeathBenefitRejectionPeriodUseCase.name;
  ...
  public async execute(
    ...
    dto: UpdateDeathBenefitRejectionPeriodRequestDto,
    ...
    const existingPeriods =
      existingDeathBenefitRejection.deathBenefitRejectionPeriod ?? [];
    const periodIds: DeathBenefitRejectionPeriodId[] = [];
    ...
    for (const existingPeriod of existingPeriods) {
      ...
      transactions.push(
        this.deathBenefitRejectionPeriodCommandRepositoryGateway.deleteDeathBenefitRejectionPeriod(
          existingPeriod.id,
        ),
      );
    }
    ...
    return UpdateDeathBenefitRejectionPeriodResponseDto.build({
      deathBenefitRejectionId,
    });
  }
}
