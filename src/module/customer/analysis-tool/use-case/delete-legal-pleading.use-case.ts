...
@Injectable()
export class DeleteLegalPleadingUseCase {
  protected readonly _type = DeleteLegalPleadingUseCase.name;
  ...
  public async execute(
    ...
    return DeleteLegalPleadingResponseDto.build({
      legalPleadingId: legalPleadingResult.id,
    });
  }
}
