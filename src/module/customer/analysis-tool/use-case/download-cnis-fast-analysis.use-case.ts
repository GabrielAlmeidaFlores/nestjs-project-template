...
export default class DownloadCnisFastAnalysisUseCase {
  protected readonly _type = DownloadCnisFastAnalysisUseCase.name;
  ...
  public async execute(
    ...
    const responseAi =
      cnisFastAnalysisQueryResult.cnisFastAnalysisResult.cnisAiAnalysis;
