...
import { InvalidCnisFastAnalysisClientNameError } from '@module/customer/analysis-tool/domain/schema/entity/cnis-fast-analysis-client/error/invalid-cnis-fast-analysis-client-name.error';
...
import type { CnisFastAnalysisClientEntityPropsInterface } from '@module/customer/analysis-tool/domain/schema/entity/cnis-fast-analysis-client/cnis-fast-analysis-client.entity.props.interface';
