...
import { InvalidLegalPleadingAddressCityError } from '@module/customer/analysis-tool/domain/schema/entity/legal-pleading-address/error/invalid-pleading-address-city.error';
import { InvalidLegalPleadingAddressNeighborhoodError } from '@module/customer/analysis-tool/domain/schema/entity/legal-pleading-address/error/invalid-pleading-address-neighborhood.error';
import { InvalidLegalPleadingAddressStreetError } from '@module/customer/analysis-tool/domain/schema/entity/legal-pleading-address/error/invalid-pleading-address-street.error';
