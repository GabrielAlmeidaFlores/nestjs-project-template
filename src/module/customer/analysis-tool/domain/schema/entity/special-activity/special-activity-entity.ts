...
import { SpecialActivityEntityPropsInterface } from '@module/customer/analysis-tool/domain/schema/entity/special-activity/special-activity-entity.props.interface';
