...
export interface RetirementPlanningRppsPeriodEntityPropsInterface
  extends BaseEntityPropsInterface<RetirementPlanningRppsPeriodId> {
  startDate: Date;
  endDate: Date;
  jobPosition: string;
  career: string;
  ...
  department: string;
  specialTimeType?: RetirementPlanningPeriodSpecialTimeTypeEnum | null;
  specialTimeStartDate?: Date | null;
  specialTimeEndDate?: Date | null;
