...
import { AnalysisToolClientCadastralFormEntityPropsInterface } from '@module/customer/analysis-tool/domain/schema/entity/analysis-tool-client-cadastral-form/analysis-tool-client-cadastral-form.entity.props.interface';
...
export class AnalysisToolClientCadastralFormEntity extends BaseEntity<AnalysisToolClientCadastralFormId> {
  ...
  @Description('Possui casa própria.')
  ...
  protected readonly _type = AnalysisToolClientCadastralFormEntity.name;

  public constructor(props: AnalysisToolClientCadastralFormEntityPropsInterface) {
    super(AnalysisToolClientCadastralFormId, props);
    ...
    this.ownHouse = props.ownHouse ?? null;
