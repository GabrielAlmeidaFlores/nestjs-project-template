...
import type { GetAnalysisToolClientInssBenefitQueryResult } from '@module/customer/analysis-tool/domain/repository/cnis-fast-analysis-inss-benefit/query/result/get-cnis-fast-analysis-inss-benefit.query.result';
...
export class GetCnisFastAnalysisWithRelationsQueryResult extends BaseBuildableObject {
  ...
  public readonly cnisFastAnalysisInssBenefit: GetAnalysisToolClientInssBenefitQueryResult[];
