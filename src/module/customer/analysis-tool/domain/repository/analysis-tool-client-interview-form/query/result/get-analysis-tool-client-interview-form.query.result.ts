...
export class GetAnalysisToolClientInterviewFormQueryResult extends BaseBuildableObject {
  public readonly id: AnalysisToolClientInterviewFormId;
  ...
  protected override readonly _type = GetAnalysisToolClientInterviewFormQueryResult.name;
}
