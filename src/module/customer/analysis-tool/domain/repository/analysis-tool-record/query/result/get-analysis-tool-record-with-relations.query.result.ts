...
import type { GetSpecialRetirementGrantQueryResult } from '@module/customer/analysis-tool/module/special-retirement-grant/domain/repository/special-retirement-grant/query/result/get-special-retirement-grant.query.result';
...
export class GetAnalysisToolRecordWithRelationsQueryResult extends BaseBuildableObject {
  ...
  public readonly specialRetirementGrant: GetSpecialRetirementGrantQueryResult | null;
