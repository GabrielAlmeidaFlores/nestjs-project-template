...
export class GetLegalPleadingWithResponsibleAndClientRelationsQueryResult extends BaseBuildableObject {
  ...
  protected override readonly _type =
    GetLegalPleadingWithResponsibleAndClientRelationsQueryResult.name;
}
