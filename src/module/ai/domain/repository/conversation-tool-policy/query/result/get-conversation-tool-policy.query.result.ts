...
import { ToolPermissionInterface } from '@module/ai/domain/schema/entity/conversation-tool-policy/conversation-tool-policy.entity.props.interface';
import { ConversationToolPolicyTypeEnum } from '@module/ai/domain/schema/entity/conversation-tool-policy/enum/conversation-tool-policy-type.enum';
...
@ResponseDto()
export class GetConversationToolPolicyQueryResult extends BaseBuildableDtoObject {
  ...
  protected override readonly _type = GetConversationToolPolicyQueryResult.name;
}
