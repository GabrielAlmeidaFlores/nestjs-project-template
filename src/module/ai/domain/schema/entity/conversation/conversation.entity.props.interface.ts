...
import type { ConversationStatusTypeEnum } from '@module/ai/domain/schema/entity/conversation/enum/conversation-status-type-enum';
...
import type { ConversationToolPolicyEntity } from '@module/ai/domain/schema/entity/conversation-tool-policy/conversation-tool-policy.entity';
