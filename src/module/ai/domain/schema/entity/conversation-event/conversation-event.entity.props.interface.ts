...
import type { ConversationEventTypeEnum } from '@module/ai/domain/schema/entity/conversation-event/enum/conversation-event-type.enum';
import type { ConversationEventId } from '@module/ai/domain/schema/entity/conversation-event/value-object/conversation-event-id/conversation-event-id.value-object';
...
export interface ConversationEventEntityPropsInterface extends BaseEntityPropsInterface<ConversationEventId> {
