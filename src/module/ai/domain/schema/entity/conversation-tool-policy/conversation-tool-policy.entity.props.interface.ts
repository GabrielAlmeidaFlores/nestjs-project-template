...
import type { ChatPersonaTypeEnum } from '@module/ai/domain/schema/entity/conversation-tool-policy/enum/chat-persona-type.enum';
import type { ConversationToolPolicyTypeEnum } from '@module/ai/domain/schema/entity/conversation-tool-policy/enum/conversation-tool-policy-type.enum';
...
export interface ConversationToolPolicyEntityPropsInterface extends BaseEntityPropsInterface<ConversationToolPolicyId> {
