...
import type { ChatPersonaTypeEnum } from '@module/ai/infra/chat/domain/schema/entity/conversation-tool-policy/enum/chat-persona-type.enum';
import type { ConversationToolPolicyTypeEnum } from '@module/ai/infra/chat/domain/schema/entity/conversation-tool-policy/enum/conversation-tool-policy-type.enum';
...
export interface ConversationToolPolicyEntityPropsInterface
  ...
  persona?: ChatPersonaTypeEnum | null;
