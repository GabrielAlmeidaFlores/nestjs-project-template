...
import type { ConversationEventEntity } from '@module/ai/chat/domain/schema/entity/conversation-event/conversation-event.entity';
import type { ConversationMessageEntity } from '@module/ai/chat/domain/schema/entity/conversation-message/conversation-message.entity';
import type { ConversationToolPolicyEntity } from '@module/ai/chat/domain/schema/entity/conversation-tool-policy/conversation-tool-policy.entity';
...
export interface ConversationEntityPropsInterface extends BaseEntityPropsInterface<ConversationId> {
