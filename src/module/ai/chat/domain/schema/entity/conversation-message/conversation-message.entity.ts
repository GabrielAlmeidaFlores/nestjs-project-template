...
import type { ConversationMessageEntityInterface } from '@module/ai/chat/domain/schema/entity/conversation-message/conversation-message.entity.props.interface';
