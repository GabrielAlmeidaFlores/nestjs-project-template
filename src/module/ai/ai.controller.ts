...
import { ChatMessagesToConversationRequestDto } from '@module/ai/dto/request/chat-messages-to-conversation.request.dto';
import { HistoryConversationRequestDto } from '@module/ai/dto/request/history-conversation.request.dto';
import { SendMessageToConversationRequestDto } from '@module/ai/dto/request/send-message-to-conversation.request.dto';
import { StartChatRequestDto } from '@module/ai/dto/request/start-chat.request.dto';
import { ListConversationMessageResponseDto } from '@module/ai/dto/response/list-conversation-message.response.dto';
import { ListConversationResponseDto } from '@module/ai/dto/response/list-conversation-response.dto';
import { SendMessageToConversationResponseDto } from '@module/ai/dto/response/send-message-to-conversation.response.dto';
import { StartChatResponseDto } from '@module/ai/dto/response/start-chat.response.dto';
...
export class AiController {
  protected readonly _type = AiController.name;
