...
@ResponseDto()
export class ListSupportTicketsResponseDto extends ListDataResponseDto<SupportTicketItemResponseDto> {
  @ResponseDtoObjectProperty(() => SupportTicketItemResponseDto, {
    isArray: true,
  })
  public override resource: SupportTicketItemResponseDto[];
