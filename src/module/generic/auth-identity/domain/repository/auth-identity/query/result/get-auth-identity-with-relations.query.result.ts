...
import type { GetSupportAttendantQueryResult } from '@module/customer/service-desk/domain/repository/support-attendant/query/result/get-support-attendant.query.result';
