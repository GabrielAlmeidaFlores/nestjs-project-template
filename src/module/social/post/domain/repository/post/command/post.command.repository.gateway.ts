...
import type { PostEntity } from '@module/social/post/domain/schema/entity/post/post.entity';
...
export abstract class PostCommandRepositoryGateway {
  ...
  public abstract updatePost(postId: PostId, entity: PostEntity): TransactionType;
