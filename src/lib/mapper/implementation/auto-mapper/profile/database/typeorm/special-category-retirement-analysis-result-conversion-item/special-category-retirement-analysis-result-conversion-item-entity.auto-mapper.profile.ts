...
export class SpecialCategoryRetirementAnalysisResultConversionItemEntityAutoMapperProfile {
  protected readonly _type =
    SpecialCategoryRetirementAnalysisResultConversionItemEntityAutoMapperProfile.name;
  ...
  private mapOrmEntityToDomainEntity(): void {
    const convert = (
      ...
      return new SpecialCategoryRetirementAnalysisResultConversionItemEntity({
        id: new SpecialCategoryRetirementAnalysisResultConversionItemId(
          source.id,
        ),
  ...
  private mapOrmEntityToQueryResult(): void {
    const convert = (
      ...
      const result =
        new GetSpecialCategoryRetirementAnalysisResultConversionItemQueryResult();
      Object.assign(result, {
        specialCategoryRetirementAnalysisResultConversionItemId:
          new SpecialCategoryRetirementAnalysisResultConversionItemId(
            source.id,
          ),
        specialCategoryRetirementAnalysisResultId:
          new SpecialCategoryRetirementAnalysisResultId(
