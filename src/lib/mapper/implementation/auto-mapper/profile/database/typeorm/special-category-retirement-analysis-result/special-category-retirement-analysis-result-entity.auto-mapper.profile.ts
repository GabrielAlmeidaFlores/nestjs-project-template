...
export class SpecialCategoryRetirementAnalysisResultEntityAutoMapperProfile {
  protected readonly _type = SpecialCategoryRetirementAnalysisResultEntityAutoMapperProfile.name;
    ...
    const convert = (
      ...
      if (!source.specialCategoryRetirementAnalysis) {
        throw new IncompleteSourceDataForMappingError({
          ...
          sourceClass: SpecialCategoryRetirementAnalysisResultTypeormEntity.name,
        });
      }
  ...
  private mapOrmEntityToQueryResult(): void {
    const convert = (
      ...
      if (!source.specialCategoryRetirementAnalysis) {
        throw new IncompleteSourceDataForMappingError({
          destinationClass: GetSpecialCategoryRetirementAnalysisResultQueryResult.name,
          sourceClass: SpecialCategoryRetirementAnalysisResultTypeormEntity.name,
        });
      }

      const result = new GetSpecialCategoryRetirementAnalysisResultQueryResult();
      Object.assign(result, {
        specialCategoryRetirementAnalysisResultId: new SpecialCategoryRetirementAnalysisResultId(source.id),
        specialCategoryRetirementAnalysisId: new SpecialCategoryRetirementAnalysisId(source.specialCategoryRetirementAnalysis.id),
        simplifiedAnalysisSummaryText: source.simplifiedAnalysisSummaryText,
        fullAnalysisConclusionText: source.fullAnalysisConclusionText,
        createdAt: source.createdAt,
