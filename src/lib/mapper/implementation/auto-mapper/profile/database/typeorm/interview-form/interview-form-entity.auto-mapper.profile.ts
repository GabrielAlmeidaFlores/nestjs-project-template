...
import type { OrganizationMemberTypeormEntity } from '@infra/database/implementation/typeorm/schema/entity/organization-member.typeorm.entity';

@Injectable()
export class InterviewFormEntityAutoMapperProfile {
  protected readonly _type = InterviewFormEntityAutoMapperProfile.name;
    ...
    const convertOrmEntityToDomainEntity = (
      ...
      if (
        ...
        throw new IncompleteSourceDataForMappingError({
          destinationClass: InterviewFormEntity.name,
          sourceClass: InterviewFormTypeormEntity.name,
        });
      }

      return new InterviewFormEntity({
        id: new InterviewFormId(source.id),
