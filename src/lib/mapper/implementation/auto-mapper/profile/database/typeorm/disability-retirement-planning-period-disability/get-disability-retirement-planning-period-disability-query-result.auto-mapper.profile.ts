...
export class GetDisabilityRetirementPlanningPeriodDisabilityQueryResultAutoMapperProfile {
  protected readonly _type = GetDisabilityRetirementPlanningPeriodDisabilityQueryResultAutoMapperProfile.name;
    ...
    const convertOrmEntityToDomainEntity = (
      ...
      if (!source.disabilityRetirementPlanningPeriodDisabilityDocument) {
        throw new IncompleteSourceDataForMappingError({
          destinationClass: GetDisabilityRetirementPlanningPeriodDisabilityQueryResult.name,
