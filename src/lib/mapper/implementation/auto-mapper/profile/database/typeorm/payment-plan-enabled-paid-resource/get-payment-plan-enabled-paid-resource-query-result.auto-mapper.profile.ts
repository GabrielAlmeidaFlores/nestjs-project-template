...
@Injectable()
export class GetPaymentPlanEnabledPaidResourceQueryResultAutoMapperProfile {
  protected readonly _type =
    GetPaymentPlanEnabledPaidResourceQueryResultAutoMapperProfile.name;
  ...
  private mapOrmEntityToQueryResult(): void {
    const convertOrmEntityToQueryResult = (
      ...
      if (!source.paymentPlan || !source.paymentPlanPaidResource) {
  ...
  private mapQueryResultToOrmEntity(): void {
    const convertQueryResultToOrmEntity = (
      source: GetPaymentPlanEnabledPaidResourceQueryResult,
    ): PaymentPlanEnabledPaidResourceTypeormEntity => {
