...
@Injectable()
export class RetirementPlanningRppsLegalProceedingEntityAutoMapperProfile {
  protected readonly _type =
    RetirementPlanningRppsLegalProceedingEntityAutoMapperProfile.name;
  ...
  private mapOrmEntityToDomainEntity(): void {
    const convertOrmEntityToDomainEntity = (
      ...
      return new RetirementPlanningRppsLegalProceedingEntity({
  ...
  private mapDomainEntityToOrmEntity(): void {
    const convertDomainEntityToOrmEntity = (
      source: RetirementPlanningRppsLegalProceedingEntity,
    ): RetirementPlanningRppsLegalProceedingTypeormEntity => {
      const retirementPlanningRpps = this.mapper.map(
        source.retirementPlanningRpps,
        RetirementPlanningRppsEntity,
