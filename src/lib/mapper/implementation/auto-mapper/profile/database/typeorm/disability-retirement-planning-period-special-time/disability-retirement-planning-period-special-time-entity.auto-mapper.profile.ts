...
export class DisabilityRetirementPlanningPeriodSpecialTimeEntityAutoMapperProfile {
  protected readonly _type = DisabilityRetirementPlanningPeriodSpecialTimeEntityAutoMapperProfile.name;
    ...
    const convertOrmEntityToDomainEntity = (
      ...
      if (!source.disabilityRetirementPlanningPeriod) {
        throw new IncompleteSourceDataForMappingError({
          destinationClass: DisabilityRetirementPlanningPeriodSpecialTimeEntity.name,
